...
import React166, { useCallback as useCallback122, useEffect as useEffect72, useMemo as useMemo120 } from "react";
...
import { useContext as useContext12, useEffect as useEffect13 } from "react";
...
import { useCallback as useCallback85, useMemo as useMemo89, useState as useState54 } from "react";
...
import { useCallback as useCallback21, useEffect as useEffect14, useMemo as useMemo27, useRef as useRef12, useState as useState20 } from "react";
...
import React36, { useCallback as useCallback22, useEffect as useEffect20, useMemo as useMemo33, useRef as useRef16, useState as useState25 } from "react";
...
var InputDraggerForwardRefFn = ({
  ...
  const onKeyPress = useCallback22((e) => {
    if (e.key === "Enter") {
  ...
  const onPointerDown = useCallback22((e) => {
...
var TimeValue = () => {
  ...
  const onTextChange = useCallback23((newVal) => {
    seek(parseInt(newVal, 10));
  }, [seek]);
  const onValueChange = useCallback23((val) => {
    seek(val);
  }, [seek]);
...
var TimelineInOutPointToggle = () => {
  ...
  const keybindings = useKeybinding();
  const onInOutClear = useCallback24((composition) => {
  ...
  const onInMark = useCallback24((e) => {
    if (!videoConfig) {
      return null;
    }
    if (e?.shiftKey) {
  ...
  const clearInMark = useCallback24((e) => {
    if (!videoConfig) {
      return null;
    }
    e.preventDefault();
  ...
  const clearOutMark = useCallback24((e) => {
    if (!videoConfig) {
      return null;
    }
    e?.preventDefault();
  ...
  const onOutMark = useCallback24((e) => {
    if (!videoConfig) {
      return null;
    }
    if (e?.shiftKey) {
...
import { useCallback as useCallback25, useMemo as useMemo37, useRef as useRef18, useState as useState26 } from "react";
...
var MenuItem = ({
  ...
  const onPointerDown = useCallback25((e) => {
    if (e.button !== 0) {
      return;
    }
    onItemSelected(id);
...
import { useCallback as useCallback26, useMemo as useMemo38, useState as useState27 } from "react";
...
var AskOnDiscord = ({ canHaveKeyboardShortcuts }) => {
  const openInBrowser = useCallback27(() => {
...
import { useCallback as useCallback29, useMemo as useMemo40, useRef as useRef19, useState as useState30 } from "react";
...
var OpenInEditor = ({ stack, canHaveKeyboardShortcuts }) => {
  ...
  const { registerKeybinding } = useKeybinding();
  const dispatchIfMounted = useCallback31((payload) => {
...
import { useCallback as useCallback32, useEffect as useEffect28 } from "react";
...
import { useCallback as useCallback33, useState as useState31 } from "react";
...
var StackElement = ({ s, lineNumberWidth, isFirst, defaultFunctionName }) => {
  ...
  const toggleCodeFrame = useCallback33(() => {
...
import { memo, useCallback as useCallback34, useContext as useContext21, useMemo as useMemo44 } from "react";
...
var GuideComp = ({ guide, canvasDimensions, scale }) => {
  ...
  const onPointerEnter = useCallback34(() => {
    setHoveredGuideId(() => guide.id);
  }, [guide.id, setHoveredGuideId]);
  const onPointerLeave = useCallback34(() => {
...
var Ruler = ({
  ...
  const changeCursor = useCallback35((e) => {
    e.preventDefault();
...
var EditorRulers = ({ contentDimensions, canvasSize, assetMetadata, containerRef }) => {
  ...
  const onMouseMove = useCallback36((e) => {
...
var Canvas = ({ canvasContent, size: size2, isRefreshing }) => {
  ...
  const fetchMetadata = useCallback37(async () => {
...
import { useCallback as useCallback38, useContext as useContext28, useEffect as useEffect35 } from "react";
...
// src/components/CurrentCompositionSideEffects.tsx
var TitleUpdater = () => {
  const renderQueue = useContext28(RenderQueueContext);
  const { canvasContent } = useContext28(Internals25.CompositionManager);
...
var CurrentCompositionKeybindings = ({ readOnlyStudio }) => {
  ...
  const { type } = useContext28(StudioServerConnectionCtx).previewServerState;
  const openRenderModal = useCallback38(() => {
    if (!video) {
      return;
    }
    if (readOnlyStudio) {
...
var CancelButton = ({ onPress, ...props }) => {
  ...
  return /* @__PURE__ */ jsx87("button", {
    ...
    type: "button",
    onClick: onPress,
    children: /* @__PURE__ */ jsx87("svg", {
      viewBox: "0 0 320 512",
      ...props,
      children: /* @__PURE__ */ jsx87("path", {
        fill: "currentColor",
...
function MobilePanel({
  ...
  return ReactDOM6.createPortal(/* @__PURE__ */ jsxs39("div", {
    ...
    children: [
      /* @__PURE__ */ jsx88("div", {
        style: buttonContainer,
        children: /* @__PURE__ */ jsx88(CancelButton, {
          style: button2,
          onPress: onClose
        })
      }),
...
var GlobalPropsEditorUpdateButton = ({ compositionId, currentDefaultProps }) => {
  ...
  return /* @__PURE__ */ jsxs40("div", {
    style: container22,
    children: [
      /* @__PURE__ */ jsx91(SchemaResetButton, {
        onClick: onReset
      }),
      /* @__PURE__ */ jsx91(SchemaSaveButton, {
        disabled,
        onClick: onClicked
      })
    ]
...
var WarningTriangle = (props) => {
  return /* @__PURE__ */ jsx92("svg", {
    viewBox: "0 0 576 512",
    ...props,
    children: /* @__PURE__ */ jsx92("path", {
...
var ValidationMessage = ({ message, align, type }) => {
  ...
  return /* @__PURE__ */ jsx92("div", {
    ...
    children: /* @__PURE__ */ jsxs41(Row, {
      ...
      justify: align,
      children: [
        /* @__PURE__ */ jsx92(WarningTriangle, {
          style: finalStyle
        }),
        /* @__PURE__ */ jsx92(Spacing, {
          x: 1
        }),
        /* @__PURE__ */ jsx92("div", {
          style: label4,
...
import { useCallback as useCallback42, useMemo as useMemo50, useState as useState35 } from "react";
...
var Item = ({ selected, onClick, children }) => {
  ...
  const { tabIndex } = useZIndex();
  const onPointerEnter = useCallback42(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback42(() => {
    setHovered(false);
  }, []);
  const itemStyle3 = useMemo50(() => {
    return {
      ...item,
...
var useZodIfPossible = () => {
  const context = useContext30(ZodContext);
...
import React64, { useCallback as useCallback43, useEffect as useEffect37, useMemo as useMemo53 } from "react";
...
var ZodErrorMessages = ({ zodValidationResult, viewTab }) => {
  ...
  const style7 = useMemo52(() => {
    return viewTab === "json" ? jsonLabel : schemaLabel;
  }, [viewTab]);
  const code = useMemo52(() => {
    return {
      ...schemaLabel,
      fontFamily: "monospace"
    };
    ...
    return /* @__PURE__ */ jsx95("div", {
      children: zodValidationResult.error.errors.map((error) => {
        return /* @__PURE__ */ jsxs42("div", {
          style: style7,
          children: [
            /* @__PURE__ */ jsx95(WarningTriangle, {
              style: triangleStyle
            }),
...
var RenderModalJSONPropsEditor = ({
  ...
  const onChange = useCallback43((e) => {
  ...
  return /* @__PURE__ */ jsxs43("div", {
    ...
    children: [
      ...
      localValue.validJSON === false ? /* @__PURE__ */ jsx96(ValidationMessage, {
        align: "flex-start",
        message: localValue.error,
        type: "error"
      }) : localValue.zodValidation.success === false ? /* @__PURE__ */ jsx96(ZodErrorMessages, {
      ...
      /* @__PURE__ */ jsxs43(Row, {
        children: [
          ...
          showSaveButton ? /* @__PURE__ */ jsx96(Button, {
            onClick: onSave,
...
import { useCallback as useCallback61, useEffect as useEffect41, useMemo as useMemo70, useState as useState44 } from "react";
...
var InvalidDefaultProps = ({ zodValidationResult }) => {
  return /* @__PURE__ */ jsxs44("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx97(ZodErrorMessages, {
        zodValidationResult,
        viewTab: "schema"
      }),
      /* @__PURE__ */ jsx97(Spacing, {
...
import React85, { useMemo as useMemo69, useState as useState43 } from "react";
...
var Fieldset = ({ children, shouldPad }) => {
  ...
  const content = /* @__PURE__ */ jsx98("div", {
    style: style8,
    children
  });
  if (shouldPad) {
    return /* @__PURE__ */ jsx98(AlreadyPaddedRightContext.Provider, {
      value: true,
      children: content
    });
  }
...
import { useCallback as useCallback45, useMemo as useMemo55, useState as useState37 } from "react";
...
var InlineRemoveButton = ({ onClick }) => {
  ...
  return /* @__PURE__ */ jsx99(InlineAction, {
    renderAction,
    onClick
  });
};
...
var SchemaLabel = ({
  ...
  const onClickablePointerEnter = useCallback45(() => {
    setClickableButtonHovered(true);
  }, []);
  const onClickablePointerLeave = useCallback45(() => {
  ...
  return /* @__PURE__ */ jsxs45("div", {
    ...
    children: [
      handleClick ? /* @__PURE__ */ jsx100("button", {
      ...
      isDefaultValue ? null : /* @__PURE__ */ jsx100(SchemaResetButton, {
        onClick: onReset
      }),
      isDefaultValue ? null : showSaveButton ? /* @__PURE__ */ jsx100(SchemaSaveButton, {
        onClick: onSave,
        disabled: disableSave
      }) : null,
      onRemove ? /* @__PURE__ */ jsx100(InlineRemoveButton, {
        onClick: onRemove
      }) : null
    ]
  });
...
import { useCallback as useCallback46, useMemo as useMemo56, useState as useState38 } from "react";
...
// src/components/RenderModal/SchemaEditor/SchemaSeparationLine.tsx
import { jsx as jsx102, jsxs as jsxs46, Fragment as Fragment18 } from "react/jsx-runtime";
...
var SchemaArrayItemSeparationLine = ({ onChange, index, schema, isLast }) => {
  ...
  const dynamicAddButtonStyle = useMemo56(() => {
    return {
      display: "flex",
      justifyContent: "center",
  ...
  const onOuterMouseEnter = useCallback46(() => {
    setOuterHovered(true);
  }, []);
  const onOuterMouseLeave = useCallback46(() => {
    setOuterHovered(false);
  }, []);
  const onInnerMouseEnter = useCallback46(() => {
    setInnerHovered(true);
  }, []);
  const onInnerMouseLeave = useCallback46(() => {
...
import React73, { useMemo as useMemo62, useState as useState41 } from "react";

// src/components/RenderModal/SchemaEditor/ZodArrayItemEditor.tsx
import { useCallback as useCallback47, useMemo as useMemo58 } from "react";
...
var ZodArrayItemEditor = ({
  ...
  const newJsonPath = useMemo58(() => [...jsonPath, index], [index, jsonPath]);
  const onSave = useCallback47((updater) => {
    onSaveObject((oldV) => [
      ...oldV.slice(0, index),
      updater(oldV[index]),
      ...oldV.slice(index + 1)
  ...
  return /* @__PURE__ */ jsx104("div", {
    children: /* @__PURE__ */ jsx104(ZodSwitch, {
...
import { useCallback as useCallback48, useEffect as useEffect38, useMemo as useMemo60, useRef as useRef23, useState as useState39 } from "react";
...
var InfoTooltip = ({ children, arrowDirection, backgroundColor }) => {
  ...
  return /* @__PURE__ */ jsxs48("div", {
    ...
    children: [
      ...
      arrowDirection === "down" ? /* @__PURE__ */ jsx105("svg", {
        viewBox: "0 0 14 7",
        style: arrowDown,
      ...
      arrowDirection === "up" ? /* @__PURE__ */ jsx105("svg", {
        viewBox: "0 0 14 7",
        style: arrowUp,
        children: /* @__PURE__ */ jsx105("path", {
...
// src/components/RenderModal/InfoBubble.tsx
import { jsx as jsx106, jsxs as jsxs49, Fragment as Fragment19 } from "react/jsx-runtime";
var icon3 = {
  color: LIGHT_TEXT,
  height: 15
};
...
var InfoBubble = ({ title: title3, children }) => {
  ...
  return /* @__PURE__ */ jsxs49(Fragment19, {
    children: [
      ...
      portalStyle ? ReactDOM7.createPortal(/* @__PURE__ */ jsx106("div", {
        style: outerPortal,
        className: "css-reset",
        children: /* @__PURE__ */ jsx106(HigherZIndex, {
          onOutsideClick: onHide,
          onEscape: onHide,
          children: /* @__PURE__ */ jsx106("div", {
            style: portalStyle,
            children: /* @__PURE__ */ jsx106(InfoTooltip, {
              backgroundColor: INPUT_BACKGROUND,
...
var ZodFieldValidation = ({ localValue, path }) => {
  ...
  return /* @__PURE__ */ jsxs50("div", {
    style: legend,
    children: [
      /* @__PURE__ */ jsx107(ValidationMessage, {
        align: "flex-start",
...
var useLocalState = ({
  ...
  const currentLocalValue = useMemo61(() => {
  ...
  const contextValue = useMemo61(() => {
    return {
      childResetRevision: resetRevision
    };
  }, [resetRevision]);
  const reset = useCallback49(() => {
    onChange(() => savedValue, true, true);
    setResetRevision((old) => old + 1);
  }, [savedValue, onChange]);
  const RevisionContextProvider = useCallback49(({ children }) => {
    return /* @__PURE__ */ jsx108(RevisionContext.Provider, {
      value: contextValue,
      children
    });
  }, [contextValue]);
...
var ZodArrayEditor = ({
  ...
  const isDefaultValue = useMemo62(() => {
  ...
  return /* @__PURE__ */ jsxs51(Fieldset, {
    ...
    children: [
      /* @__PURE__ */ jsx109("div", {
        ...
        children: /* @__PURE__ */ jsx109(SchemaLabel, {
          onReset: reset,
          isDefaultValue,
          jsonPath,
          onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx109(RevisionContextProvider, {
          ...
          children: [
            localValue.value.map((child, i) => {
              return /* @__PURE__ */ jsxs51(React73.Fragment, {
                children: [
                  /* @__PURE__ */ jsx109(ZodArrayItemEditor, {
                    onChange,
                    value: child,
                    def,
                    index: i,
                  ...
                  /* @__PURE__ */ jsx109(SchemaArrayItemSeparationLine, {
                    schema,
                    index: i,
                    onChange,
            ...
            value.length === 0 ? /* @__PURE__ */ jsx109(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true
      ...
      /* @__PURE__ */ jsx109(ZodFieldValidation, {
        path: jsonPath,
        localValue
      })
    ]
...
var Checkbox = ({ checked, onChange, disabled, name }) => {
  ...
  return /* @__PURE__ */ jsxs52("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx110("div", {
        style: box,
        children: checked ? /* @__PURE__ */ jsx110(Checkmark, {}) : null
      })
    ]
  });
};
...
var ZodBooleanEditor = ({
  ...
  const onToggle = useCallback50((e) => {
  ...
  return /* @__PURE__ */ jsxs53(Fieldset, {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx111("div", {
        style: fullWidth,
        children: /* @__PURE__ */ jsx111(Checkbox, {
          name: jsonPath.join("."),
...
import { useCallback as useCallback51, useMemo as useMemo65 } from "react";
...
import { useCallback as useCallback53, useMemo as useMemo66 } from "react";
import { jsx as jsx116, jsxs as jsxs56 } from "react/jsx-runtime";
var ZodDiscriminatedUnionEditor = ({
  ...
  const options = useMemo66(() => [...typedSchema.optionsMap.keys()], [typedSchema.optionsMap]);
  const {
    localValue,
    onChange: setLocalValue,
    reset
  ...
  const discriminatedUnionReplacement = useMemo66(() => {
    return {
...
import { useCallback as useCallback54, useMemo as useMemo67 } from "react";
...
import { jsx as jsx119, jsxs as jsxs59 } from "react/jsx-runtime";
var fullWidth5 = {
  width: "100%"
};
var emptyLabel = {
...
import { jsx as jsx120, jsxs as jsxs60 } from "react/jsx-runtime";
var labelStyle4 = {
  fontFamily: "sans-serif",
  fontSize: 14,
  color: LIGHT_TEXT
...
import { useCallback as useCallback58, useMemo as useMemo68 } from "react";
...
var ZodUnionEditor = ({
  ...
  if (options.length > 2) {
    return /* @__PURE__ */ jsx127(ZonNonEditableValue, {
      jsonPath,
...
var ZodSwitch = ({
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx128(ZodObjectEditor, {
      setValue,
      unsavedValue: value,
      savedValue: defaultValue,
      jsonPath,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodString) {
    if (value.startsWith(window.remotion_staticBase)) {
      return /* @__PURE__ */ jsx128(ZodStaticFileEditor, {
        setValue,
        value,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_TEXTAREA_BRAND) {
      return /* @__PURE__ */ jsx128(ZodTextareaEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    return /* @__PURE__ */ jsx128(ZodStringEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDate) {
    return /* @__PURE__ */ jsx128(ZodDateEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNumber) {
    return /* @__PURE__ */ jsx128(ZodNumberEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodBoolean) {
    return /* @__PURE__ */ jsx128(ZodBooleanEditor, {
      value,
      setValue,
      jsonPath,
      defaultValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodArray) {
    return /* @__PURE__ */ jsx128(ZodArrayEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEnum) {
    return /* @__PURE__ */ jsx128(ZodEnumEditor, {
      setValue,
      value,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodEffects) {
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_COLOR_BRAND) {
      return /* @__PURE__ */ jsx128(ZodColorEditor, {
        value,
        setValue,
        jsonPath,
        schema,
    ...
    return /* @__PURE__ */ jsx128(ZodEffectEditor, {
      value,
      setValue,
      jsonPath,
      schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUnion) {
    return /* @__PURE__ */ jsx128(ZodUnionEditor, {
      schema,
      showSaveButton,
      jsonPath,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodOptional) {
    return /* @__PURE__ */ jsx128(ZodOptionalEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNullable) {
    return /* @__PURE__ */ jsx128(ZodNullableEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDefault) {
    return /* @__PURE__ */ jsx128(ZodDefaultEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDiscriminatedUnion) {
    return /* @__PURE__ */ jsx128(ZodDiscriminatedUnionEditor, {
      defaultValue,
      mayPad,
      schema,
      setValue,
...
var ZodObjectEditor = ({
  ...
  return /* @__PURE__ */ jsxs65(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      isRoot ? null : /* @__PURE__ */ jsx129(SchemaLabel, {
        isDefaultValue,
        onReset: reset,
        jsonPath,
        onRemove,
      ...
      expanded ? /* @__PURE__ */ jsx129(RevisionContextProvider, {
        children: /* @__PURE__ */ jsx129(SchemaVerticalGuide, {
          isRoot,
          children: keys.map((key, i) => {
            ...
            return /* @__PURE__ */ jsxs65(React85.Fragment, {
              children: [
                ...
                i === keys.length - 1 ? null : /* @__PURE__ */ jsx129(SchemaSeparationLine, {})
              ]
            }, key);
          })
        })
      }) : null,
      isRoot || !expanded ? null : /* @__PURE__ */ jsx129("div", {
        style: fieldsetLabel,
        children: "}"
      })
    ]
...
var SchemaEditor = ({
  ...
  if (!zodValidationResult.success) {
    ...
    if (!defaultPropsValid.success) {
      return /* @__PURE__ */ jsx130(InvalidDefaultProps, {
        zodValidationResult
      });
    }
    return /* @__PURE__ */ jsx130(InvalidSchema, {
      reset,
      zodValidationResult
    });
  }
  if (typeName !== z.ZodFirstPartyTypeKind.ZodObject) {
    return /* @__PURE__ */ jsx130(TopLevelZodValue, {
  ...
  return /* @__PURE__ */ jsx130("div", {
    ...
    style: scrollable2,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: /* @__PURE__ */ jsx130(RevisionContext.Provider, {
      value: revisionState,
      children: /* @__PURE__ */ jsx130(ZodObjectEditor, {
        discriminatedUnionReplacement: null,
...
var WarningIndicatorButton = ({ setShowWarning, showWarning, warningCount }) => {
  ...
  return /* @__PURE__ */ jsxs66("button", {
    ...
    onClick,
    children: [
      /* @__PURE__ */ jsx131(WarningTriangle2, {
        style: triangleStyle2
      }),
      /* @__PURE__ */ jsx131(Spacing, {
        x: 0.5
      }),
      warningCount,
      /* @__PURE__ */ jsx131(Spacing, {
...
var DataEditor = ({
  ...
  const zodValidationResult = useMemo72(() => {
    if (schema === "no-zod") {
      return "no-zod";
    }
    if (schema === "no-schema") {
  ...
  const setShowWarning = useCallback63((val) => {
  ...
  const canSaveDefaultProps = useMemo72(() => {
  ...
  const onSave = useCallback63((updater) => {
    if (schema === "no-zod" || schema === "no-schema" || z === null) {
      showNotification("Cannot update default props: No Zod schema", 2000);
      return;
    }
  ...
  if (schema === "no-zod") {
    return /* @__PURE__ */ jsx132(ZodNotInstalled, {});
  }
  if (schema === "no-schema") {
    return /* @__PURE__ */ jsx132(NoSchemaDefined, {});
  }
  if (!z) {
    throw new Error("expected zod");
  }
  ...
  if (!unresolvedComposition.defaultProps) {
    return /* @__PURE__ */ jsx132(NoDefaultProps, {});
  }
  return /* @__PURE__ */ jsxs67("div", {
    style: outer,
    children: [
      /* @__PURE__ */ jsxs67("div", {
        ...
        children: [
          /* @__PURE__ */ jsxs67("div", {
            style: tabWrapper,
            children: [
              /* @__PURE__ */ jsx132(SegmentedControl, {
                items: modeItems,
                needsWrapping: false
              }),
              /* @__PURE__ */ jsx132(Flex, {}),
              warnings.length > 0 ? /* @__PURE__ */ jsx132(WarningIndicatorButton, {
                setShowWarning,
                showWarning,
          ...
          showWarning && warnings.length > 0 ? warnings.map((warning) => /* @__PURE__ */ jsxs67(React88.Fragment, {
            children: [
              ...
              /* @__PURE__ */ jsx132(ValidationMessage, {
                message: warning,
                align: "flex-start",
                type: "warning"
              })
      ...
      mode === "schema" ? /* @__PURE__ */ jsx132(SchemaEditor, {
      ...
      }) : /* @__PURE__ */ jsx132(RenderModalJSONPropsEditor, {
        value: defaultProps ?? {},
        setValue: setDefaultProps,
        onSave: onUpdate,
        showSaveButton,
...
var RenderQueueCopyToClipboard = ({ job }) => {
  const renderCopyAction = useCallback64((color) => {
    return /* @__PURE__ */ jsx133(ClipboardIcon, {
...
import { useCallback as useCallback66, useMemo as useMemo73 } from "react";
import { jsx as jsx135 } from "react/jsx-runtime";
var RenderQueueCancelButton = ({ job }) => {
  const onClick = useCallback66((e) => {
    e.stopPropagation();
  ...
  const renderAction = useCallback66((color) => {
    return /* @__PURE__ */ jsx135("svg", {
      style: icon4,
      xmlns: "http://www.w3.org/2000/svg",
      viewBox: "0 0 512 512",
...
var CircularProgress = ({ progress }) => {
  ...
  return /* @__PURE__ */ jsx136("svg", {
    ...
    children: /* @__PURE__ */ jsx136("circle", {
...
var RenderQueueItemStatus = ({ job }) => {
  ...
  const onPointerLeave = useCallback67(() => {
    setHovered(false);
  }, []);
  ...
  if (job.status === "running") {
    return /* @__PURE__ */ jsx137("button", {
      ...
      style: invisibleStyle,
      onClick,
      children: /* @__PURE__ */ jsx137(CircularProgress, {
...
import { useCallback as useCallback68, useMemo as useMemo74 } from "react";
...
var RenderQueueOpenInFinderItem = ({ job }) => {
  ...
  const renderAction = useCallback68((color) => {
    return /* @__PURE__ */ jsx138(ExpandedFolderIconSolid, {
      style: icon4,
      color
    });
  }, [icon4]);
...
import { useCallback as useCallback70, useMemo as useMemo76 } from "react";
...
// src/components/RenderQueue/RenderQueueItem.tsx
import { jsx as jsx143, jsxs as jsxs68 } from "react/jsx-runtime";
var container29 = {
  padding: 12,
  display: "flex",
  flexDirection: "row",
...
var RenderQueueItem = ({ job, selected }) => {
  ...
  const containerStyle2 = useMemo78(() => {
    return {
      ...container29,
      backgroundColor: getBackgroundFromHoverState({
  ...
  const scrollCurrentIntoView = useCallback72(() => {
  ...
  return /* @__PURE__ */ jsxs68(Row, {
    ...
    children: [
      /* @__PURE__ */ jsx143(RenderQueueItemStatus, {
        job
      }),
      /* @__PURE__ */ jsx143(Spacing, {
        x: 1
      }),
      /* @__PURE__ */ jsxs68("div", {
        style: right,
        children: [
          ...
          /* @__PURE__ */ jsx143("div", {
            style: subtitle2,
            children: job.status === "done" ? /* @__PURE__ */ jsx143(RenderQueueOutputName, {
              job
            }) : job.status === "failed" ? /* @__PURE__ */ jsx143(RenderQueueError, {
              job
            }) : job.status === "running" ? /* @__PURE__ */ jsx143(RenderQueueProgressMessage, {
              job
            }) : null
          })
        ]
      ...
      supportsCopyingToClipboard(job) ? /* @__PURE__ */ jsx143(RenderQueueCopyToClipboard, {
        job
      }) : null,
      job.status === "done" || job.status === "failed" ? /* @__PURE__ */ jsx143(RenderQueueRepeatItem, {
        job
      }) : null,
      job.status === "running" ? /* @__PURE__ */ jsx143(RenderQueueCancelButton, {
        job
      }) : /* @__PURE__ */ jsx143(RenderQueueRemoveItem, {
        job
      }),
      job.status === "done" ? /* @__PURE__ */ jsx143(RenderQueueOpenInFinderItem, {
        job
      }) : null
    ]
  });
  ...
  return /* @__PURE__ */ jsx144("div", {
    ...
    children: jobs.map((j, index) => {
      return /* @__PURE__ */ jsx144("div", {
        ...
        children: /* @__PURE__ */ jsx144(RenderQueueItem, {
...
import { jsx as jsx145, jsxs as jsxs70, Fragment as Fragment20 } from "react/jsx-runtime";
var row3 = {
  display: "flex",
  flexDirection: "row",
  fontSize: 14,
...
var OptionsPanel = ({ readOnlyStudio }) => {
  ...
  const onPropsSelected = useCallback73(() => {
    setPanel("input-props");
    persistSelectedOptionsSidebarPanel2("input-props");
  }, []);
  const onRendersSelected = useCallback73(() => {
    setPanel("renders");
  ...
  const setDefaultProps = useCallback73((newProps) => {
    if (composition === null) {
      return;
    }
    window.remotion_ignoreFastRefreshUpdate = null;
  ...
  const currentDefaultProps = useMemo81(() => {
    if (composition === null) {
      return {};
    }
    return props[composition.id] ?? composition.defaultProps ?? {};
  }, [composition, props]);
  const unsavedChangesExist = useMemo81(() => {
  ...
  return /* @__PURE__ */ jsxs71("div", {
    ...
    children: [
        ...
        children: /* @__PURE__ */ jsxs71(Tabs, {
          children: [
            composition ? /* @__PURE__ */ jsxs71(Tab, {
              ...
              children: [
                "Props",
                unsavedChangesExist ? /* @__PURE__ */ jsx146(GlobalPropsEditorUpdateButton, {
                  compositionId: composition.id,
                  currentDefaultProps
                }) : null
              ]
            }) : null,
            readOnlyStudio ? null : /* @__PURE__ */ jsx146(RendersTab, {
      ...
      panel === `input-props` && composition ? /* @__PURE__ */ jsx146(DataEditor, {
        ...
        setSaving,
        readOnlyStudio
      }, composition.id) : readOnlyStudio ? null : /* @__PURE__ */ jsx146(RenderQueue, {})
    ]
  });
};
...
var CheckboardToggle = () => {
  const { checkerboard, setCheckerboard } = useContext42(CheckerboardContext);
  const onClick = useCallback74(() => {
    setCheckerboard((c) => {
      return !c;
    });
  }, [setCheckerboard]);
  return /* @__PURE__ */ jsx147(ControlButton, {
    title: accessibilityLabel2,
    "aria-label": accessibilityLabel2,
    onClick,
    children: /* @__PURE__ */ jsx147("svg", {
      "aria-hidden": "true",
      focusable: "false",
      "data-prefix": "fas",
...
var MuteToggle = ({ muted, setMuted }) => {
  ...
  return /* @__PURE__ */ jsx151(ControlButton, {
    ...
    onClick,
    children: muted ? /* @__PURE__ */ jsx151(VolumeOffIcon, {}) : /* @__PURE__ */ jsx151(VolumeOnIcon, {})
  });
};

// src/components/PlayPause.tsx
import { PlayerInternals as PlayerInternals12 } from "@remotion/player";
import { useCallback as useCallback78, useEffect as useEffect48, useState as useState49 } from "react";
...
var Pause = (props) => /* @__PURE__ */ jsx153("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
var Play = (props) => /* @__PURE__ */ jsx154("svg", {
  ...props,
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "fas",
...
// src/components/PlayPause.tsx
import { jsx as jsx157, jsxs as jsxs73, Fragment as Fragment21 } from "react/jsx-runtime";
var backStyle = {
  height: 18,
  color: "white"
};
...
var PlayPause = ({ playbackRate, loop, bufferStateDelayInMilliseconds }) => {
  ...
  const onEnter = useCallback78((e) => {
    if (playing) {
      e.preventDefault();
      pauseAndReturnToPlayStart();
    }
  }, [pauseAndReturnToPlayStart, playing]);
  const onArrowLeft = useCallback78((e) => {
    e.preventDefault();
    if (e.altKey) {
      seek(0);
      ensureFrameIsInViewport({
  ...
  const onArrowRight = useCallback78((e) => {
    if (e.altKey) {
  ...
  const oneFrameBack = useCallback78(() => {
    frameBack(1);
  }, [frameBack]);
  const oneFrameForward = useCallback78(() => {
    frameForward(1);
  }, [frameForward]);
  const jumpToStart = useCallback78(() => {
    seek(inFrame ?? 0);
  }, [seek, inFrame]);
  const jumpToEnd = useCallback78(() => {
  ...
  return /* @__PURE__ */ jsxs73(Fragment21, {
    children: [
      /* @__PURE__ */ jsx157(ControlButton, {
        "aria-label": "Jump to beginning",
        title: "Jump to beginning",
        disabled: !videoConfig || isFirstFrame,
        onClick: jumpToStart,
        children: /* @__PURE__ */ jsx157(JumpToStart, {
          style: backStyle
        })
      }),
      /* @__PURE__ */ jsx157(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx157(StepBack, {
      ...
      /* @__PURE__ */ jsx157(ControlButton, {
        ...
        children: playing ? showBufferIndicator ? /* @__PURE__ */ jsx157(PlayerInternals12.BufferingIndicator, {
          type: "studio"
        }) : /* @__PURE__ */ jsx157(Pause, {
          style: iconButton
        }) : /* @__PURE__ */ jsx157(Play, {
          style: iconButton
        })
      }),
      /* @__PURE__ */ jsx157(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx157(StepForward, {
          style: forwardBackStyle
        })
      })
    ]
...
var PlaybackKeyboardShortcutsManager = ({ setPlaybackRate }) => {
  ...
  const onKKey = useCallback79(() => {
    setPlaybackRate(1);
    pause();
  }, [pause, setPlaybackRate]);
  const onLKey = useCallback79(() => {
    setPlaybackRate((prevPlaybackRate) => {
      if (!playing) {
        return 1;
      }
...
var PlaybackRateSelector = ({ playbackRate, setPlaybackRate }) => {
  ...
  const items = useMemo83(() => {
    ...
    const values = commonPlaybackRates.map((newPlaybackRate) => {
      return {
        ...
        keyHint: null,
        leftItem: String(playbackRate) === String(newPlaybackRate) ? /* @__PURE__ */ jsx158(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
  ...
  return /* @__PURE__ */ jsx158("div", {
    style: style9,
    "aria-label": accessibilityLabel5,
    children: /* @__PURE__ */ jsx158(Combobox, {
      title: accessibilityLabel5,
      style: comboStyle2,
...
import { jsx as jsx159, jsxs as jsxs74 } from "react/jsx-runtime";
var button3 = {
  paddingLeft: 7,
  paddingRight: 7,
  paddingTop: 7,
...
var RenderButton = () => {
  ...
  return /* @__PURE__ */ jsx159(Button, {
    ...
    children: /* @__PURE__ */ jsxs74(Row, {
      align: "center",
      children: [
        /* @__PURE__ */ jsx159(RenderIcon, {
          svgProps: iconStyle4
        }),
        /* @__PURE__ */ jsx159(Spacing, {
          x: 1
        }),
        /* @__PURE__ */ jsx159("span", {
          style: label7,
          children: "Render"
        })
      ]
...
// src/components/Timeline/TimelineZoomControls.tsx
import { jsx as jsx161, jsxs as jsxs75 } from "react/jsx-runtime";
var container30 = {
  color: "black",
  flexDirection: "row",
  display: "flex",
  ...
  return /* @__PURE__ */ jsxs75("div", {
    ...
    children: [
      /* @__PURE__ */ jsx161(ControlButton, {
        ...
        children: /* @__PURE__ */ jsx161(Minus, {
          style: iconStyle4
        })
      }),
...
// src/components/PreviewToolbar.tsx
import { jsx as jsx162, jsxs as jsxs76, Fragment as Fragment22 } from "react/jsx-runtime";
var container31 = {
  display: "flex",
  justifyContent: "center",
    ...
    children: [
      /* @__PURE__ */ jsxs76("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx162(TimelineZoomControls, {})
        ]
      }),
      /* @__PURE__ */ jsx162(Flex, {}),
      /* @__PURE__ */ jsx162(SizeSelector, {}),
      isStill || isVideoComposition ? /* @__PURE__ */ jsx162(PlaybackRateSelector, {
        setPlaybackRate,
        playbackRate
      }) : null,
      isVideoComposition ? /* @__PURE__ */ jsxs76(Fragment22, {
        children: [
          ...
          /* @__PURE__ */ jsx162(LoopToggle, {
            loop,
            setLoop
          }),
          /* @__PURE__ */ jsx162(MuteToggle, {
            muted: mediaMuted,
          ...
          /* @__PURE__ */ jsx162(TimelineInOutPointToggle, {}),
          /* @__PURE__ */ jsx162(Spacing, {
            x: 2
          })
        ]
      }) : null,
      /* @__PURE__ */ jsx162(CheckboardToggle, {}),
      /* @__PURE__ */ jsx162(Spacing, {
        x: 1
      }),
      isFullscreenSupported && /* @__PURE__ */ jsx162(FullScreenToggle, {}),
      /* @__PURE__ */ jsx162(Flex, {}),
      /* @__PURE__ */ jsxs76("div", {
        style: sideContainer,
        children: [
          /* @__PURE__ */ jsx162(Flex, {}),
          /* @__PURE__ */ jsx162(FpsCounter, {
            playbackSpeed: playbackRate
          }),
          /* @__PURE__ */ jsx162(Spacing, {
            x: 2
          }),
          readOnlyStudio ? null : /* @__PURE__ */ jsx162(RenderButton, {}),
          /* @__PURE__ */ jsx162(Spacing, {
            x: 1.5
          })
        ]
      }),
      /* @__PURE__ */ jsx162(PlaybackKeyboardShortcutsManager, {
        setPlaybackRate
      }),
      /* @__PURE__ */ jsx162(PlaybackRatePersistor, {})
    ]
  });
};

// src/components/Splitter/SplitterContainer.tsx
import { useEffect as useEffect51, useMemo as useMemo85, useRef as useRef27, useState as useState51 } from "react";
...
var SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
  ...
  const [domRect, setDomRect] = useState51(null);
  const ref = useRef27(null);
  const isDragging = useRef27(false);
  const [resizeObserver] = useState51(() => {
  ...
  return /* @__PURE__ */ jsx163(SplitterContext.Provider, {
    value,
    children: /* @__PURE__ */ jsx163("div", {
      ref,
...
import { jsx as jsx164, jsxs as jsxs77, Fragment as Fragment23 } from "react/jsx-runtime";
var SplitterElement = ({ children, type, sticky }) => {
  const context = useContext49(SplitterContext);
...
var SplitterHandle = ({ allowToCollapse, onCollapse }) => {
  ...
  useEffect52(() => {
    ...
    const cleanup = () => {
      ...
      PlayerInternals14.updateAllElementsSizes();
    };
    current.addEventListener("pointerdown", onPointerDown);
    return () => {
      if (!context.isDragging.current) {
...
var TopPanel = ({
  ...
  const sizeWithRulersApplied = useMemo87(() => {
    ...
    return {
      ...size4,
      width: size4.width - RULER_WIDTH,
      height: size4.height - RULER_WIDTH
    };
  }, [rulersAreVisible, size4]);
  const onCollapseLeft = useCallback82(() => {
    setSidebarCollapsedState({ left: "collapsed", right: null });
  }, [setSidebarCollapsedState]);
  const onCollapseRight = useCallback82(() => {
    ...
    children: [
      /* @__PURE__ */ jsx166("div", {
        ...
        children: /* @__PURE__ */ jsxs78(SplitterContainer, {
          ...
          orientation: "vertical",
          children: [
            actualStateLeft === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx166(MobilePanel, {
              onClose: onCollapseLeft,
              children: /* @__PURE__ */ jsx166(ExplorerPanel, {
                readOnlyStudio
              })
            }) : /* @__PURE__ */ jsx166(SplitterElement, {
              sticky: null,
              type: "flexer",
              children: /* @__PURE__ */ jsx166(ExplorerPanel, {
                readOnlyStudio
            ...
            actualStateLeft === "expanded" ? /* @__PURE__ */ jsx166(SplitterHandle, {
                ...
                children: [
                  /* @__PURE__ */ jsx166(SplitterElement, {
                    ...
                    children: /* @__PURE__ */ jsx166("div", {
                      ...
                      children: sizeWithRulersApplied ? /* @__PURE__ */ jsx166(CanvasOrLoading, {
                        size: sizeWithRulersApplied
                      }) : null
                    })
                  }),
                  actualStateRight === "expanded" ? /* @__PURE__ */ jsx166(SplitterHandle, {
                    allowToCollapse: "right",
                    onCollapse: onCollapseRight
                  }) : null,
                  actualStateRight === "expanded" ? isMobileLayout ? /* @__PURE__ */ jsx166(MobilePanel, {
                    onClose: onCollapseRight,
                    children: /* @__PURE__ */ jsx166(OptionsPanel, {
                      readOnlyStudio
                    })
                  }) : /* @__PURE__ */ jsx166(SplitterElement, {
                    sticky: null,
      ...
      /* @__PURE__ */ jsx166(PreviewToolbar, {
        bufferStateDelayInMilliseconds,
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx166(CurrentCompositionKeybindings, {
        readOnlyStudio
      }),
      /* @__PURE__ */ jsx166(TitleUpdater, {})
    ]
  });
};

// src/components/SidebarCollapserControls.tsx
import { jsx as jsx167, jsxs as jsxs79, Fragment as Fragment24 } from "react/jsx-runtime";
var style9 = {
  width: 16,
  height: 16,
  minWidth: 16,
...
var SidebarCollapserControls = () => {
  ...
  const rightIcon = useCallback83((color) => {
    return {
      width: "35%",
      height: "100%",
      right: 0,
  ...
  const toggleLeft = useCallback83(() => {
    setSidebarCollapsedState({
      left: (s) => {
        if (s === "responsive") {
  ...
  const toggleRight = useCallback83(() => {
    setSidebarCollapsedState({
      right: (s) => s === "collapsed" ? "expanded" : "collapsed",
      left: null
    });
  }, [setSidebarCollapsedState]);
  const toggleBoth = useCallback83(() => {
  ...
  const colorStyle = useCallback83((color) => {
    return {
      ...style9,
      color
    };
  }, []);
  const toggleLeftAction = useCallback83((color) => {
  ...
  const toggleRightAction = useCallback83((color) => {
    return /* @__PURE__ */ jsx167("div", {
      style: colorStyle(color),
...
var UpdateCheck = () => {
  ...
  const checkForUpdates = useCallback84(() => {
  ...
  const checkForBugs = useCallback84(() => {
    const controller = new AbortController;
  ...
  const dynButtonStyle = useMemo88(() => {
    return {
      ...buttonStyle4,
  ...
  return /* @__PURE__ */ jsx168("button", {
    tabIndex,
    style: dynButtonStyle,
    onClick: openModal,
    type: "button",
    title: hasKnownBugs ? "Bugfixes available" : "Update available",
    children: hasKnownBugs ? "Bugfixes available" : /* @__PURE__ */ jsx168("svg", {
      xmlns: "http://www.w3.org/2000/svg",
      style: {
        height: 16,
        width: 16
...
// src/components/MenuToolbar.tsx
import { jsx as jsx169, jsxs as jsxs80 } from "react/jsx-runtime";
var row5 = {
  alignItems: "center",
  flexDirection: "row",
  display: "flex",
...
var MenuToolbar = ({ readOnlyStudio }) => {
  ...
  const mobileLayout = useMobileLayout();
  const fixedWidthRight = useMemo89(() => {
    return {
  ...
  const fixedWidthLeft = useMemo89(() => {
    return {
  ...
  const itemClicked = useCallback85((itemId) => {
    setSelected(itemId);
  }, [setSelected]);
  const itemHovered = useCallback85((itemId) => {
    if (selected) {
      setSelected(itemId);
    }
  }, [selected, setSelected]);
  const closeMenu = useCallback85(() => {
    setSelected(null);
  }, []);
  const structure = useMenuStructure(closeMenu, readOnlyStudio);
  const menus = useMemo89(() => {
    return structure.map((s) => s.id);
  }, [structure]);
  const onPreviousMenu = useCallback85(() => {
    setSelected((s) => {
      if (s === null) {
        return null;
      }
  ...
  const onNextMenu = useCallback85(() => {
    setSelected((s) => {
      if (s === null) {
        return null;
      }
  ...
  const onItemQuit = useCallback85(() => {
    setSelected(null);
  }, [setSelected]);
  return /* @__PURE__ */ jsxs80(Row, {
    ...
    children: [
      /* @__PURE__ */ jsxs80("div", {
        ...
        children: [
          structure.map((s) => {
            return /* @__PURE__ */ jsx169(MenuItem, {
          ...
          readOnlyStudio ? null : /* @__PURE__ */ jsx169(UpdateCheck, {})
        ]
      }),
      /* @__PURE__ */ jsx169("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx169(MenuBuildIndicator, {}),
      /* @__PURE__ */ jsx169("div", {
        style: flex2
      }),
      /* @__PURE__ */ jsx169("div", {
        style: fixedWidthRight,
        children: /* @__PURE__ */ jsx169(SidebarCollapserControls, {})
      }),
      /* @__PURE__ */ jsx169(Spacing, {
        x: 1
      })
    ]
  });
...
import { jsx as jsx170, jsxs as jsxs82, Fragment as Fragment25 } from "react/jsx-runtime";
var areaHighlight = {
  position: "absolute",
...
var TimelineInOutPointer = () => {
  ...
  return /* @__PURE__ */ jsxs82(Fragment25, {
    children: [
      inFrame !== null && /* @__PURE__ */ jsx170("div", {
        ref: inMarkerAreaRef,
        style: {
          ...areaHighlight,
          left: 0,
      ...
      outFrame !== null && /* @__PURE__ */ jsx170("div", {
...
var TimelineInOutPointerHandle = ({
  ...
  return /* @__PURE__ */ jsx171(InnerTimelineInOutPointerHandle, {
    atFrame,
    dragging,
    timelineWidth,
    type
...
var TimelineDragHandler = () => {
  ...
  return /* @__PURE__ */ jsx172("div", {
    ref: sliderAreaRef,
    style: containerStyle2,
    children: video ? /* @__PURE__ */ jsx172(Inner2, {}) : null
  });
};
var Inner2 = () => {
  const videoConfig = useVideoConfig4();
  const size4 = PlayerInternals15.useElementSize(scrollableRef, {
    triggerOnWindowResize: true,
    shouldApplyCssTransforms: true
  });
  const { isHighestContext } = useZIndex();
  ...
  const { playing, play, pause, seek } = PlayerInternals15.usePlayer();
  ...
  const onPointerDown = useCallback86((e) => {
    if (e.button !== 0) {
      return;
    }
    if (!isHighestContext) {
  ...
  const onPointerMoveScrubbing = useCallback86((e) => {
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerMoveInOut = useCallback86((e) => {
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerUpScrubbing = useCallback86((e) => {
    stopInterval();
    if (!videoConfig) {
      return;
    }
  ...
  const onPointerUpInOut = useCallback86((e) => {
    if (!videoConfig) {
      return;
    }
    if (!inOutDragging.dragging) {
  ...
  const outContextMenu = useMemo91(() => {
    return [
      {
        id: "hide-out",
        keyHint: null,
  ...
  return /* @__PURE__ */ jsxs83("div", {
    ...
    children: [
      ...
      inFrame !== null && /* @__PURE__ */ jsx172(ContextMenu, {
        values: inContextMenu,
        children: /* @__PURE__ */ jsx172(TimelineInOutPointerHandle, {
          type: "in",
          atFrame: inFrame,
          dragging: inOutDragging.dragging === "in"
        })
      }),
      outFrame !== null && /* @__PURE__ */ jsx172(ContextMenu, {
...
import { useCallback as useCallback87 } from "react";
...
var TimelineLayerEye = ({ onInvoked, hidden, type }) => {
  const renderAction = useCallback87((color) => {
    if (hidden) {
      return null;
    }
    if (type === "speaker") {
  ...
  const onPointerEnter = useCallback87(() => {
    if (layerPointedDown) {
      onInvoked(layerPointedDown);
    }
  }, [onInvoked]);
...
// src/components/Timeline/TimelineStack/index.tsx
import { jsx as jsx174, jsxs as jsxs84, Fragment as Fragment26 } from "react/jsx-runtime";
...
var TimelineStack = ({ isCompact, sequence }) => {
  ...
  const navigateToAsset = useCallback88((asset) => {
    selectAsset(asset);
    pushUrl(`/assets/${asset}`);
  }, [selectAsset]);
  const openEditor = useCallback88(async (location2) => {
  ...
  const onClickTitle = useCallback88(() => {
    if (!titleHoverable) {
      return null;
    }
    if (assetPath) {
  ...
  const onClickStack = useCallback88(() => {
    if (!originalLocation) {
      return;
    }
    if (canOpenInEditor) {
  ...
  const onStackPointerEnter = useCallback88(() => {
    setStackHovered(true);
  }, []);
  const onStackPointerLeave = useCallback88(() => {
    setStackHovered(false);
  }, []);
  const onTitlePointerEnter = useCallback88(() => {
    setTitleHovered(true);
  }, []);
  const onTitlePointerLeave = useCallback88(() => {
    setTitleHovered(false);
  }, []);
  const style11 = useMemo92(() => {
    return {
      fontSize: 12,
  ...
  return /* @__PURE__ */ jsxs84(Fragment26, {
    children: [
      ...
      isCompact || !originalLocation ? null : /* @__PURE__ */ jsx174("div", {
...
var TimelineListItem = ({ nestedDepth, sequence, isCompact }) => {
  ...
  const isItemHidden = useMemo93(() => {
    return hidden[sequence.id] ?? false;
  }, [hidden, sequence.id]);
  const onToggleVisibility = useCallback89((type) => {
    setHidden((prev) => {
      return {
        ...prev,
  ...
  return /* @__PURE__ */ jsxs85("div", {
    style: outer2,
    children: [
      /* @__PURE__ */ jsx175(TimelineLayerEye, {
      ...
      sequence.parent && nestedDepth > 0 ? /* @__PURE__ */ jsx175("div", {
        style: space
      }) : null,
      /* @__PURE__ */ jsx175(TimelineStack, {
        sequence,
        isCompact
      })
    ]
...
var TimelineTimePlaceholders = () => {
  return /* @__PURE__ */ jsx176("div", {
    style: timeValue,
    children: /* @__PURE__ */ jsx176(TimeValue, {})
  });
};
...
var TimelineTimeIndicators = () => {
  ...
  const video = Internals46.useVideo();
  if (sliderTrack === null) {
    return null;
  }
  if (video === null) {
...
var Inner3 = ({ windowWidth, durationInFrames, fps }) => {
  ...
  return /* @__PURE__ */ jsx176("div", {
    ...
    children: ticks.map((t) => {
      return /* @__PURE__ */ jsx176("div", {
        style: t.style,
        children: t.showTime ? /* @__PURE__ */ jsx176("div", {
          style: tickLabel,
...
// src/components/Timeline/TimelineList.tsx
import { jsx as jsx177, jsxs as jsxs86 } from "react/jsx-runtime";
var container37 = {
  flex: 1,
  background: BACKGROUND
};
var TimelineList = ({ timeline }) => {
  ...
  const size4 = PlayerInternals16.useElementSize(ref, {
    shouldApplyCssTransforms: false,
    triggerOnWindowResize: false
  });
  ...
  return /* @__PURE__ */ jsxs86("div", {
    ...
    style: container37,
    children: [
      /* @__PURE__ */ jsx177(TimelineTimePadding, {}),
      timeline.map((track) => {
        return /* @__PURE__ */ jsx177("div", {
          children: /* @__PURE__ */ jsx177(TimelineListItem, {
...
import { useEffect as useEffect60, useMemo as useMemo97, useRef as useRef32, useState as useState57 } from "react";
...
var AudioWaveform = ({
  ...
  const vidConf = Internals48.useUnsafeVideoConfig();
  if (vidConf === null) {
  ...
  return /* @__PURE__ */ jsxs87("div", {
    ...
    children: [
      normalized.map((w) => {
        return /* @__PURE__ */ jsx180(AudioWaveformBar, {
          amplitude: w.amplitude
        }, w.index);
      }),
      /* @__PURE__ */ jsx180("canvas", {
        ref: canvas,
        style: canvasStyle,
...
var LoopedTimelineIndicator = ({ loops }) => {
  return /* @__PURE__ */ jsx182(AbsoluteFill3, {
    style: row6,
    children: new Array(loops).fill(true).map((_l, i) => {
      return /* @__PURE__ */ jsxs89(React127.Fragment, {
        children: [
          /* @__PURE__ */ jsx182(Flex, {}),
          i === loops - 1 ? null : /* @__PURE__ */ jsx182(LoopedIndicator, {})
        ]
      }, i);
    })
  });
...
import { useEffect as useEffect61, useRef as useRef33, useState as useState58 } from "react";
...
var Inner4 = ({ s, windowWidth }) => {
  ...
  const { marginLeft, width: width2, premountWidth } = useMemo98(() => {
  ...
  return /* @__PURE__ */ jsxs90("div", {
    ...
    title: s.displayName,
    children: [
      premountWidth ? /* @__PURE__ */ jsx185("div", {
        style: {
          width: premountWidth,
          height: "100%",
      ...
      s.type === "audio" ? /* @__PURE__ */ jsx185(AudioWaveform, {
        src: s.src,
      ...
      s.type === "video" ? /* @__PURE__ */ jsx185(TimelineVideoInfo, {
        src: s.src
      }) : null,
      s.loopDisplay === undefined ? null : /* @__PURE__ */ jsx185(LoopedTimelineIndicator, {
        loops: s.loopDisplay.numberOfTimes
      }),
      s.type !== "audio" && s.type !== "video" && s.loopDisplay === undefined && (isInRange || isPremounting) ? /* @__PURE__ */ jsx185("div", {
        style: {
        ...
        children: /* @__PURE__ */ jsx185(TimelineSequenceFrame, {
...
// src/components/Timeline/TimelineTracks.tsx
import { jsx as jsx186, jsxs as jsxs91 } from "react/jsx-runtime";
var content = {
  ...
  return /* @__PURE__ */ jsxs91("div", {
    ...
    children: [
      /* @__PURE__ */ jsxs91("div", {
        style: content,
        children: [
          /* @__PURE__ */ jsx186(TimelineTimePadding, {}),
          timeline.map((track) => {
            ...
            return /* @__PURE__ */ jsx186("div", {
              style: inner2,
              children: /* @__PURE__ */ jsx186(TimelineSequence, {
                s: track.sequence
              })
            }, track.sequence.id);
          })
      ...
      hasBeenCut ? /* @__PURE__ */ jsx186(MaxTimelineTracksReached, {}) : null
    ]
  });
};
...
var Timeline = () => {
  ...
  return /* @__PURE__ */ jsx187("div", {
    ...
    children: /* @__PURE__ */ jsx187(TimelineWidthProvider, {
      children: /* @__PURE__ */ jsx187("div", {
        style: inner2,
        children: /* @__PURE__ */ jsxs92(SplitterContainer, {
          ...
          minFlex: 0.15,
          children: [
            /* @__PURE__ */ jsx187(SplitterElement, {
              type: "flexer",
              sticky: /* @__PURE__ */ jsx187(TimelineTimePlaceholders, {}),
              children: /* @__PURE__ */ jsx187(TimelineList, {
                timeline: shown
              })
            }),
            /* @__PURE__ */ jsx187(SplitterHandle, {
              onCollapse: noop2,
            ...
            /* @__PURE__ */ jsx187(SplitterElement, {
              ...
              children: /* @__PURE__ */ jsxs92(TimelineScrollable, {
                children: [
                  /* @__PURE__ */ jsx187(TimelineTracks, {
                    timeline: shown,
                    hasBeenCut
                  }),
                  /* @__PURE__ */ jsx187(TimelineInOutPointer, {}),
                  /* @__PURE__ */ jsx187(TimelinePlayCursorSyncer, {}),
                  /* @__PURE__ */ jsx187(TimelineDragHandler, {}),
                  /* @__PURE__ */ jsx187(TimelineTimeIndicators, {}),
                  /* @__PURE__ */ jsx187(TimelineSlider, {})
                ]
              })
            })
          ]
...
// src/components/EditorContent.tsx
import { jsx as jsx188, jsxs as jsxs93, Fragment as Fragment27 } from "react/jsx-runtime";
var noop3 = () => {
  return;
};
var container41 = {
...
var EditorContent = ({ readOnlyStudio, children }) => {
  ...
  return /* @__PURE__ */ jsxs93("div", {
    style: container41,
    children: [
      /* @__PURE__ */ jsx188(InitialCompositionLoader, {}),
      /* @__PURE__ */ jsx188(MenuToolbar, {
        readOnlyStudio
      }),
          ...
          onlyTopPanel ? null : /* @__PURE__ */ jsxs93(Fragment27, {
            children: [
              ...
              /* @__PURE__ */ jsx188(SplitterElement, {
                sticky: null,
                type: "anti-flexer",
                children: /* @__PURE__ */ jsx188(Timeline, {})
              })
            ]
          })
        ]
...
import React136, { useCallback as useCallback92, useContext as useContext67, useEffect as useEffect63 } from "react";
...
var InstallablePackageComp = ({ isInstalled, pkg, link, description }) => {
  return /* @__PURE__ */ jsxs94("div", {
    ...
    children: [
      ...
      " ",
      isInstalled ? /* @__PURE__ */ jsx189("span", {
        style: { opacity: 0.3, fontSize: "inherit" },
        children: "(installed)"
      }) : null,
      /* @__PURE__ */ jsx189("br", {}),
      /* @__PURE__ */ jsx189("span", {
...
var ModalHeader = ({ title: title4 }) => {
  ...
  return /* @__PURE__ */ jsxs95("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx192(Flex, {}),
      /* @__PURE__ */ jsx192(CancelButton, {
        style: icon5,
        onPress
      })
    ]
...
var ModalContainer = ({ children, onEscape, onOutsideClick }) => {
  return /* @__PURE__ */ jsx193("div", {
    ...
    role: "dialog",
    "aria-modal": "true",
    children: /* @__PURE__ */ jsx193(HigherZIndex, {
      onOutsideClick,
      onEscape,
...
var DismissableModal = ({ children }) => {
  ...
  const onQuit = useCallback91(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  return /* @__PURE__ */ jsx194(ModalContainer, {
...
var InstallPackageModal = ({ packageManager }) => {
  ...
  const onClick = useCallback92(async () => {
    if (state.type === "done") {
  ...
  return /* @__PURE__ */ jsxs96(DismissableModal, {
    children: [
      ...
      /* @__PURE__ */ jsx195("div", {
        ...
        }) : state.type === "restarting" ? /* @__PURE__ */ jsx195("div", {
          style: text2,
          ...
          children: listOfInstallableRemotionPackages.map((pkg) => {
            ...
            return /* @__PURE__ */ jsxs96(Row, {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx195(Spacing, {
                  x: 1.5
                }),
                /* @__PURE__ */ jsx195(InstallablePackageComp, {
                  description,
                  isInstalled,
                  link,
                  pkg
      ...
      /* @__PURE__ */ jsx195(ModalFooterContainer, {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxs96(ModalButton, {
              ...
              children: [
                ...
                disabled ? null : /* @__PURE__ */ jsx195(ShortcutHint, {
                  keyToPress: "\u21B5",
                  cmdOrCtrl: true
                })
              ]
...
import { useCallback as useCallback94, useContext as useContext70, useMemo as useMemo103 } from "react";

// src/components/RenderModal/ResolveCompositionBeforeModal.tsx
import React137, { useContext as useContext68, useEffect as useEffect64, useMemo as useMemo102 } from "react";
...
var ResolveCompositionBeforeModal = ({ compositionId, children }) => {
  ...
  const unresolvedContext = useContext68(Internals52.CompositionManager);
  ...
  if (!resolved || resolved.type === "loading") {
    return /* @__PURE__ */ jsx196(RunningCalculateMetadata, {});
  }
  if (resolved.type === "error") {
  ...
  return /* @__PURE__ */ jsx196(ResolvedCompositionContext.Provider, {
    value,
    children
  });
};
...
import { useCallback as useCallback93, useContext as useContext69, useEffect as useEffect65, useState as useState60 } from "react";
...
var CodemodFooter = ({
  ...
  const getCanApplyCodemod = useCallback93(async (signal) => {
  ...
  return /* @__PURE__ */ jsxs99(Row, {
    align: "center",
    children: [
      /* @__PURE__ */ jsx198(CodemodDiffPreview, {
...
// src/components/NewComposition/DeleteComposition.tsx
import { jsx as jsx199, jsxs as jsxs100, Fragment as Fragment28 } from "react/jsx-runtime";
var content3 = {
  padding: 16,
  fontSize: 14,
  flex: 1,
...
var DeleteCompositionLoaded = ({ compositionId }) => {
  const context = useContext70(ResolvedCompositionContext);
  if (!context) {
  ...
  const onSubmit = useCallback94((e) => {
    e.preventDefault();
  }, []);
  return /* @__PURE__ */ jsxs100(Fragment28, {
    children: [
      /* @__PURE__ */ jsx199(ModalHeader, {
      ...
      /* @__PURE__ */ jsxs100("form", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx199(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx199(CodemodFooter, {
...
var DeleteComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx199(DismissableModal, {
    children: /* @__PURE__ */ jsx199(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx199(DeleteCompositionLoaded, {
        compositionId
      })
    })
  });
...
import { useCallback as useCallback96, useContext as useContext71, useMemo as useMemo104, useState as useState61 } from "react";
...
var validateCompositionName = (compName, compositions) => {
  if (!Internals53.isCompositionIdValid(compName)) {
    return Internals53.invalidCompositionErrorMessage;
  }
...
import { jsx as jsx200, jsxs as jsxs101, Fragment as Fragment29 } from "react/jsx-runtime";
var NewCompDuration = ({ durationInFrames, setDurationInFrames }) => {
  const onDurationInFramesChanged = useCallback95((newValue) => {
    setDurationInFrames(Number(newValue));
  }, [setDurationInFrames]);
  const onDurationChangedDirectly = useCallback95((newVal) => {
        ...
        children: [
          ...
          compDurationErrMessage ? /* @__PURE__ */ jsxs101(Fragment29, {
            children: [
              ...
              /* @__PURE__ */ jsx200(ValidationMessage, {
                align: "flex-start",
...
// src/components/NewComposition/DuplicateComposition.tsx
import { jsx as jsx201, jsxs as jsxs102, Fragment as Fragment30 } from "react/jsx-runtime";
var content4 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var DuplicateCompositionLoaded = ({ initialType }) => {
  ...
  const { compositions } = useContext71(Internals54.CompositionManager);
  ...
  const onTypeChanged = useCallback96((newType) => {
    setType(newType);
  }, []);
  const onWidthChanged = useCallback96((newValue) => {
    setSize((s) => {
      const { height } = s;
  ...
  const onWidthDirectlyChanged = useCallback96((newWidth) => {
    setSize((s) => {
      const { height } = s;
      return {
        height,
  ...
  const onHeightDirectlyChanged = useCallback96((newHeight) => {
    setSize((s) => {
  ...
  const onHeightChanged = useCallback96((newValue) => {
    setSize((s) => {
      const { width: width2 } = s;
  ...
  const onNameChange = useCallback96((e) => {
    setName(e.target.value);
  }, []);
  const onTextFpsChange = useCallback96((newFps) => {
    setFrameRate(Number(newFps));
  }, []);
  const onFpsChange = useCallback96((newFps) => {
    setFrameRate(newFps);
  }, []);
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs102("form", {
        ...
        children: [
            ...
            children: [
              initialCompType === "composition" ? /* @__PURE__ */ jsxs102("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx201("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx201(Combobox, {
              ...
              type === "composition" && hadDurationDefined ? /* @__PURE__ */ jsx201(NewCompDuration, {
                durationInFrames,
                setDurationInFrames
              }) : null,
              type === "composition" && hadFpsDefined ? /* @__PURE__ */ jsxs102("div", {
                ...
                children: [
                  ...
                  /* @__PURE__ */ jsx201("div", {
                    style: rightRow,
                    children: /* @__PURE__ */ jsx201(InputDragger, {
                      type: "number",
          ...
          /* @__PURE__ */ jsx201(ModalFooterContainer, {
            children: /* @__PURE__ */ jsx201(CodemodFooter, {
...
var DuplicateComposition = ({ compositionId, compositionType }) => {
  return /* @__PURE__ */ jsx201(DismissableModal, {
    children: /* @__PURE__ */ jsx201(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx201(DuplicateCompositionLoaded, {
...
import { useCallback as useCallback97, useContext as useContext72, useMemo as useMemo105, useState as useState62 } from "react";
import { Internals as Internals55 } from "remotion";
import { jsx as jsx202, jsxs as jsxs103, Fragment as Fragment31 } from "react/jsx-runtime";
var content5 = {
  padding: 12,
  paddingRight: 12,
  flex: 1,
...
var RenameComposition = ({ compositionId }) => {
  return /* @__PURE__ */ jsx202(DismissableModal, {
    children: /* @__PURE__ */ jsx202(ResolveCompositionBeforeModal, {
      compositionId,
      children: /* @__PURE__ */ jsx202(RenameCompositionLoaded, {})
    })
  });
};
                ...
                children: [
                  /* @__PURE__ */ jsxs104("div", {
                    ...
                    children: [
                      /* @__PURE__ */ jsx204("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx204(ShiftIcon, {})
                      }),
                      ...
                      /* @__PURE__ */ jsx204("kbd", {
                        style: key4,
                        children: /* @__PURE__ */ jsx204(ArrowLeft, {})
                      })
                    ]
                  }),
                  /* @__PURE__ */ jsx204("div", {
              ...
              /* @__PURE__ */ jsxs104(Row, {
                ...
                children: [
                  /* @__PURE__ */ jsx204("div", {
                    ...
                    children: /* @__PURE__ */ jsx204("kbd", {
                      style: key4,
                      children: /* @__PURE__ */ jsx204(ArrowRight, {})
                    })
                  }),
                  /* @__PURE__ */ jsx204("div", {
                    style: right2,
...
import { useEffect as useEffect66, useMemo as useMemo106, useRef as useRef34, useState as useState63 } from "react";
import { jsx as jsx206, jsxs as jsxs106, Fragment as Fragment32 } from "react/jsx-runtime";
var container46 = {
  paddingLeft: 16,
  paddingRight: 16,
  display: "flex",
...
var QuickSwitcherResult = ({ result, selected }) => {
  ...
  return /* @__PURE__ */ jsxs106("div", {
    ...
    children: [
      result.type === "composition" ? result.compositionType === "still" ? /* @__PURE__ */ jsx206(StillIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : /* @__PURE__ */ jsx206(FilmIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : null,
...
import { jsx as jsx207, jsxs as jsxs107, Fragment as Fragment33 } from "react/jsx-runtime";
var input2 = {
  width: "100%"
};
var modeSelector = {
...
var QuickSwitcherContent = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  ...
  const onArrowDown = useCallback98(() => {
    setState((s) => {
      return {
        ...s,
  ...
  const onTextChange = useCallback98((e) => {
  ...
  const onActionsSelected = useCallback98(() => {
    setState((s) => ({
  ...
  const onCompositionsSelected = useCallback98(() => {
    setState((s) => ({
      query: stripQuery(s.query),
      selectedIndex: 0
    }));
  ...
  const onDocSearchSelected = useCallback98(() => {
    setState((s) => ({
      query: `? ${stripQuery(s.query)}`,
      selectedIndex: 0
    }));
  ...
  const container47 = useMemo107(() => {
    return {
      width: showKeyboardShortcuts ? 800 : 500
    };
  }, [showKeyboardShortcuts]);
  const results = useMemo107(() => {
  ...
  return /* @__PURE__ */ jsxs107("div", {
    ...
    children: [
      ...
      /* @__PURE__ */ jsx207("div", {
        style: results,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: showKeyboardShortcuts ? /* @__PURE__ */ jsx207(KeyboardShortcutsExplainer, {}) : showSearchLoadingState ? null : resultsArray.length === 0 ? /* @__PURE__ */ jsx207(QuickSwitcherNoResults, {
          mode,
          query: actualQuery
        }) : resultsArray.map((result, i) => {
          return /* @__PURE__ */ jsx207(QuickSwitcherResult, {
...
var QuickSwitcher = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx208(DismissableModal, {
    children: /* @__PURE__ */ jsx208(QuickSwitcherContent, {
      readOnlyStudio,
      invocationTimestamp,
      initialMode
    })
...
import { useMemo as useMemo108, useState as useState65 } from "react";
var useRenderModalSections = (renderMode, codec) => {
  const [selectedTab, setTab] = useState65("general");
  const shownTabs = useMemo108(() => {
    if (renderMode === "audio") {
...
var AudioIcon = (props) => /* @__PURE__ */ jsx209("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
  children: /* @__PURE__ */ jsx209("path", {
    fill: "currentcolor",
...
var PicIcon = (props) => /* @__PURE__ */ jsx211("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GearIcon = (props) => /* @__PURE__ */ jsx212("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var GifIcon = (props) => /* @__PURE__ */ jsx213("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 576 512",
  ...props,
...
import { useCallback as useCallback99, useMemo as useMemo109, useState as useState66 } from "react";
...
var VerticalTab = ({ children, onClick, style: style11, selected }) => {
  ...
  const { tabIndex } = useZIndex();
  const onPointerEnter = useCallback99(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback99(() => {
    setHovered(false);
  }, []);
  const definiteStyle = useMemo109(() => {
    return {
      ...selectorButton2,
...
import { useCallback as useCallback100, useEffect as useEffect68, useMemo as useMemo110, useState as useState67 } from "react";
...
var CliCopyButton = ({
  ...
  const fillColor = useMemo110(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const clipboardIcon = /* @__PURE__ */ jsx215(ClipboardIcon, {
    color: fillColor,
    style: svgStyle3
  });
  const checkSvg = /* @__PURE__ */ jsx215("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    style: svgStyle3,
  ...
  return copied ? /* @__PURE__ */ jsx215("span", {
    style: copiedStyle,
    children: checkSvg
  }) : /* @__PURE__ */ jsx215("button", {
    type: "button",
    onPointerEnter,
    onPointerLeave,
    style: buttonStyle6,
...
import { jsx as jsx216, jsxs as jsxs108 } from "react/jsx-runtime";
var container47 = {
  fontSize: 14,
  paddingTop: 10,
  paddingBottom: 10,
        ...
        children: [
          /* @__PURE__ */ jsxs108("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx216("div", {
                style: copyWrapper,
                children: /* @__PURE__ */ jsx216(CliCopyButton, {
...
var OptionExplainerBubble = ({ id }) => {
  ...
  return /* @__PURE__ */ jsx217(InfoBubble, {
    title: "Learn more about this option",
    children: /* @__PURE__ */ jsx217(OptionExplainer, {
      option
    })
  });
};
...
// src/components/RenderModal/NumberSetting.tsx
import { jsx as jsx218, jsxs as jsxs109, Fragment as Fragment34 } from "react/jsx-runtime";
var NumberSetting = ({ name, value, step, hint, onValueChanged, max, min, formatter }) => {
  const onTextChanged = useCallback101((e) => {
    onValueChanged((q) => {
  ...
  const onValueChange = useCallback101((newConcurrency) => {
  ...
  return /* @__PURE__ */ jsxs109("div", {
    ...
    children: [
        ...
        children: [
          ...
          hint ? /* @__PURE__ */ jsxs109(Fragment34, {
            children: [
              ...
              /* @__PURE__ */ jsx218(OptionExplainerBubble, {
                id: hint
              })
            ]
          }) : null
      ...
      /* @__PURE__ */ jsx218("div", {
        style: rightRow,
        children: /* @__PURE__ */ jsx218(RightAlignInput, {
          children: /* @__PURE__ */ jsx218(InputDragger, {
            value,
...
var CrfSetting = ({ crf, setCrf, min, max, option }) => {
  return /* @__PURE__ */ jsx219(NumberSetting, {
    min,
    max,
    name: "CRF",
...
import { useCallback as useCallback105, useMemo as useMemo111 } from "react";
...
import React147, { useCallback as useCallback103 } from "react";
...
var InlineEyeButton = ({ onClick, enabled }) => {
  const renderAction = useCallback102((color) => {
    return enabled ? /* @__PURE__ */ jsx220("svg", {
      style: clearIcon2,
      viewBox: "0 0 640 512",
  ...
  return /* @__PURE__ */ jsx220(InlineAction, {
    renderAction,
    onClick
  });
};
...
// src/components/RenderModal/EnvInput.tsx
import { jsx as jsx221, jsxs as jsxs110, Fragment as Fragment35 } from "react/jsx-runtime";
var input3 = {
  flex: 1,
  width: "100%"
};
...
var EnvInput = ({
  ...
  const togglePlainText = useCallback103(() => {
    setShowInPlainText((prev) => !prev);
  }, []);
  const handleKeyChange = useCallback103((e) => {
    onEnvKeyChange(index, e.target.value);
  }, [index, onEnvKeyChange]);
  const handleValueChange = useCallback103((e) => {
    onEnvValChange(index, e.target.value);
  }, [index, onEnvValChange]);
  const makeKeyWarningEligible = useCallback103(() => {
    setKeyWarningEligible(true);
  }, []);
  const makeValueWarningEligible = useCallback103(() => {
    ...
    children: [
      /* @__PURE__ */ jsxs110(Row, {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx221(InlineEyeButton, {
            enabled: !showInPlainText,
            onClick: togglePlainText
          }),
          /* @__PURE__ */ jsx221(InlineRemoveButton, {
            onClick: handleDelete
          })
        ]
      }),
      isNodeEnvKey ? /* @__PURE__ */ jsx221("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx221(ValidationMessage, {
          align: "flex-start",
          type: "warning",
          message: "NODE_ENV will be overwritten by Remotion during the render process."
        })
      }) : null,
      isDuplicate ? /* @__PURE__ */ jsx221("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx221(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isKeyMissing ? /* @__PURE__ */ jsx221("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx221(ValidationMessage, {
          align: "flex-start",
          type: "warning",
      ...
      isValMissing ? /* @__PURE__ */ jsx221("div", {
        style: validationStyle,
        children: /* @__PURE__ */ jsx221(ValidationMessage, {
          align: "flex-start",
          type: "warning",
...
// src/components/RenderModal/RenderModalEnvironmentVariables.tsx
import { jsx as jsx222, jsxs as jsxs111 } from "react/jsx-runtime";
var title6 = {
  fontSize: 14,
  fontWeight: "bold",
  color: LIGHT_TEXT,
...
var RenderModalEnvironmentVariables = ({ envVariables, setEnvVariables }) => {
  const onEnvValChange = useCallback104((index, value) => {
  ...
  const onEnvKeyChange = useCallback104((index, value) => {
    setEnvVariables((oldEnv) => {
      const newEnv = [...oldEnv];
  ...
  const onDelete = useCallback104((index) => {
    setEnvVariables((oldEnv) => oldEnv.filter((_, idx) => idx !== index));
  }, [setEnvVariables]);
  const addField = useCallback104(() => {
  ...
  return /* @__PURE__ */ jsxs111("div", {
    ...
    children: [
      ...
      envVariables.map((env, i) => {
        ...
        return /* @__PURE__ */ jsx222(EnvInput, {
          onEnvKeyChange,
          onEnvValChange,
          envKey: env[0],
          envVal: env[1],
...
var RenderModalHr = () => {
  return /* @__PURE__ */ jsx223("div", {
    style: hrStyle
  });
};

// src/components/RenderModal/RenderModalAdvanced.tsx
import { jsx as jsx224, jsxs as jsxs112 } from "react/jsx-runtime";
var container49 = {
  flex: 1,
  overflowY: "auto"
};
var RenderModalAdvanced = ({
  ...
  const extendedOpenGlOptions = useMemo111(() => {
    return [
      "angle",
      "egl",
      "swangle",
  ...
  const toggleCustomOffthreadVideoCacheSizeInBytes = useCallback105(() => {
  ...
  const toggleCustomUserAgent = useCallback105(() => {
  ...
  const onDisallowParallelEncodingChanged = useCallback105((e) => {
    setDisallowParallelEncoding(e.target.checked);
  }, [setDisallowParallelEncoding]);
  const onDisableWebSecurityChanged = useCallback105((e) => {
    setDisableWebSecurity(e.target.checked);
  }, [setDisableWebSecurity]);
  const onEnableMultiProcessOnLinux = useCallback105((e) => {
    setChromiumMultiProcessOnLinux(e.target.checked);
  }, [setChromiumMultiProcessOnLinux]);
  const onIgnoreCertificatErrors = useCallback105((e) => {
    setIgnoreCertificateErrors(e.target.checked);
  }, [setIgnoreCertificateErrors]);
  const onHeadless = useCallback105((e) => {
    setHeadless(e.target.checked);
  }, [setHeadless]);
  const onUserAgentChanged = useCallback105((e) => {
    setUserAgent(e.target.value);
  }, [setUserAgent]);
  const onPlayBeepSound = useCallback105((e) => {
    setBeep(e.target.checked);
  }, [setBeep]);
  const onReproToggle = useCallback105((e) => {
    setRepro(e.target.checked);
  }, [setRepro]);
  const openGlOptions = useMemo111(() => {
    return extendedOpenGlOptions.map((option) => {
      return {
        label: option === "default" ? "Default" : option,
        onClick: () => setOpenGlOption(option),
        key: option,
        leftItem: openGlOption === option ? /* @__PURE__ */ jsx224(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const x264PresetOptions = useMemo111(() => {
    return BrowserSafeApis3.x264PresetOptions.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: x264Preset === option ? /* @__PURE__ */ jsx224(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        value: option
      };
  ...
  const hardwareAccelerationValues = useMemo111(() => {
    return BrowserSafeApis3.hardwareAccelerationOptions.map((option) => {
      return {
        label: option,
        onClick: () => setHardwareAcceleration(option),
        leftItem: hardwareAcceleration === option ? /* @__PURE__ */ jsx224(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null,
        type: "item",
        id: option,
  ...
  const changeOffthreadVideoCacheSizeInBytes = useCallback105((cb) => {
  ...
  return /* @__PURE__ */ jsxs112("div", {
    ...
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: [
      renderMode === "still" ? null : /* @__PURE__ */ jsx224(NumberSetting, {
        min: minConcurrency,
        max: maxConcurrency,
        step: 1,
        name: "Concurrency",
        ...
        children: [
          /* @__PURE__ */ jsxs112("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx224(OptionExplainerBubble, {
                id: "x264Option"
              })
            ]
          }),
          /* @__PURE__ */ jsx224("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx224(Combobox, {
              title: x264Preset,
      ...
      /* @__PURE__ */ jsxs112("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx224("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx224(Checkbox, {
      ...
      renderMode === "audio" || offthreadVideoCacheSizeInBytes === null ? null : /* @__PURE__ */ jsx224(NumberSetting, {
        min: minConcurrency,
        max: 2000 * 1024 * 1024,
        step: 1024,
        ...
        children: [
          ...
          /* @__PURE__ */ jsx224("div", {
            ...
            children: /* @__PURE__ */ jsx224("div", {
              children: /* @__PURE__ */ jsx224(RemotionInput, {
                style: input,
                value: userAgent,
      ...
      /* @__PURE__ */ jsx224(RenderModalHr, {}),
      /* @__PURE__ */ jsx224(RenderModalEnvironmentVariables, {
        envVariables,
        setEnvVariables
      })
    ]
...
import { jsx as jsx225, jsxs as jsxs113 } from "react/jsx-runtime";
var EnforceAudioTrackSetting = ({ enforceAudioTrack, muted, setEnforceAudioTrack }) => {
  const onEnforceAudioTrackChanged = useCallback106((e) => {
...
import { jsx as jsx226, jsxs as jsxs114 } from "react/jsx-runtime";
var MutedSetting = ({ muted, setMuted, enforceAudioTrack }) => {
  const onMutedChanged = useCallback107((e) => {
...
import { useContext as useContext74, useEffect as useEffect69, useRef as useRef36, useState as useState69 } from "react";
var useFileExistence = (outName) => {
  const [exists, setExists] = useState69(false);
  const { previewServerState: state, subscribeToEvent } = useContext74(StudioServerConnectionCtx);
...
import { jsx as jsx227, jsxs as jsxs115, Fragment as Fragment36 } from "react/jsx-runtime";
          ...
          children: [
            ...
            validationMessage ? /* @__PURE__ */ jsxs115(Fragment36, {
              children: [
                ...
                /* @__PURE__ */ jsx227(ValidationMessage, {
                  align: "flex-end",
...
// src/components/RenderModal/SeparateAudioOption.tsx
import { jsx as jsx228, jsxs as jsxs116, Fragment as Fragment37 } from "react/jsx-runtime";
var SeparateAudioOptionInput = ({ separateAudioTo, setSeparateAudioTo, audioCodec }) => {
  ...
  const validationMessage = useMemo112(() => {
  ...
  return /* @__PURE__ */ jsx228(RenderModalOutputName, {
    existence,
    inputStyle: input,
    onValueChange,
...
var SeparateAudioOption = ({ separateAudioTo, setSeparateAudioTo, audioCodec, outName }) => {
  const onSeparateAudioChange = useCallback108((e) => {
    if (e.target.checked) {
  ...
  return /* @__PURE__ */ jsxs116(Fragment37, {
    children: [
      ...
      separateAudioTo === null ? null : /* @__PURE__ */ jsx228(SeparateAudioOptionInput, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec
      })
...
// src/components/RenderModal/RenderModalAudio.tsx
import { jsx as jsx229, jsxs as jsxs117, Fragment as Fragment38 } from "react/jsx-runtime";
var container50 = {
  flex: 1,
  overflowY: "auto"
};
var RenderModalAudio = ({
  ...
  const onShouldHaveTargetAudioBitrateChanged = useCallback109((e) => {
    setShouldHaveCustomTargetAudioBitrate(e.target.checked);
  }, [setShouldHaveCustomTargetAudioBitrate]);
  const onTargetAudioBitrateChanged = useCallback109((e) => {
    setCustomTargetAudioBitrateValue(e.target.value);
  }, [setCustomTargetAudioBitrateValue]);
  const onSeamlessAacConcatenationChanges = useCallback109((e) => {
    setForSeamlessAacConcatenation(e.target.checked);
  }, [setForSeamlessAacConcatenation]);
  const audioCodecOptions = useCallback109((currentCodec) => {
    return BrowserSafeApis5.supportedAudioCodecs[currentCodec].map((audioCodecOption) => {
      return {
        ...
        leftItem: codec === audioCodecOption ? /* @__PURE__ */ jsx229(Checkmark, {}) : null,
        id: audioCodecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  return /* @__PURE__ */ jsxs117("div", {
    ...
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs117(Fragment38, {
        children: [
          /* @__PURE__ */ jsx229(MutedSetting, {
            enforceAudioTrack,
            muted,
            setMuted
          }),
          /* @__PURE__ */ jsx229(RenderModalHr, {})
        ]
      }) : null,
      renderMode === "video" && audioCodecOptions(codec).length >= 2 && !muted ? /* @__PURE__ */ jsxs117("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx229("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx229(Combobox, {
      ...
      (renderMode === "video" || renderMode === "audio") && !muted && /* @__PURE__ */ jsxs117(Fragment38, {
        children: [
          /* @__PURE__ */ jsx229(EnforceAudioTrackSetting, {
            muted,
            enforceAudioTrack,
      ...
      renderMode === "video" && !muted ? /* @__PURE__ */ jsx229(SeparateAudioOption, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec,
        outName
      ...
      shouldHaveCustomTargetAudioBitrate && renderMode !== "still" && !muted ? /* @__PURE__ */ jsxs117("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx229("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx229("div", {
              children: /* @__PURE__ */ jsx229(RemotionInput, {
                style: input,
...
import { useCallback as useCallback110, useMemo as useMemo113 } from "react";
...
var MultiRangeSlider = ({
  ...
  const getPercent = useCallback110((value) => Math.round((value - min) / (max - min) * 100), [min, max]);
  const rangeStyle = useMemo113(() => {
  ...
  const onChangeLeft = useCallback110((event) => {
    const value = Math.min(Number(event.target.value), end - 1);
    onLeftThumbDrag(value);
  }, [end, onLeftThumbDrag]);
  const onChangeRight = useCallback110((event) => {
...
// src/components/RenderModal/FrameRangeSetting.tsx
import { jsx as jsx231, jsxs as jsxs119 } from "react/jsx-runtime";
var numberWrapper = {
  minWidth: "39px",
  display: "flex",
  justifyContent: "flex-end",
...
var FrameRangeSetting = ({ startFrame, endFrame, setEndFrame, durationInFrames, setStartFrame }) => {
  ...
  const onStartFrameChangedDirectly = useCallback111((newStartFrame) => {
    setStartFrame(newStartFrame);
  }, [setStartFrame]);
  const onEndFrameChangedDirectly = useCallback111((newEndFrame) => {
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs119("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx231(MultiRangeSlider, {
            min: minStartFrame,
            max: maxEndFrame,
            start: startFrame,
            end: endFrame,
...
// src/components/RenderModal/RenderModalBasic.tsx
import { jsx as jsx232, jsxs as jsxs120 } from "react/jsx-runtime";
var container52 = {
  flex: 1
};
var RenderModalBasic = ({
  ...
  const videoCodecOptions = useMemo114(() => {
    return BrowserSafeApis6.validCodecs.filter((c) => {
      ...
      return {
        ...
        key: codecOption,
        leftItem: codec === codecOption ? /* @__PURE__ */ jsx232(Checkmark, {}) : null,
        id: codecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const proResProfileOptions = useMemo114(() => {
  ...
  const onFrameSetDirectly = useCallback112((newFrame) => {
    setFrame(newFrame);
  }, [setFrame]);
  const onFrameChanged = useCallback112((e) => {
    setFrame((q) => {
  ...
  const onValueChange = useCallback112((e) => {
    setOutName(e.target.value);
  }, [setOutName]);
  const onVerboseLoggingChanged = useCallback112((e) => {
    ...
    children: [
      renderMode === "still" || renderMode === "sequence" ? /* @__PURE__ */ jsxs120("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx232("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx232(SegmentedControl, {
      ...
      renderMode === "still" && resolvedComposition.durationInFrames > 1 ? /* @__PURE__ */ jsxs120("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx232("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx232(RightAlignInput, {
              children: /* @__PURE__ */ jsx232(InputDragger, {
                value: frame2,
      ...
      renderMode === "still" ? null : /* @__PURE__ */ jsx232(FrameRangeSetting, {
      ...
      /* @__PURE__ */ jsx232(RenderModalOutputName, {
        existence,
        inputStyle: input,
        outName,
        onValueChange,
...
var NumberOfLoopsSetting = ({ numberOfGifLoops, setNumberOfGifLoops }) => {
  const onNumberOfGifLoopsChangedDirectly = useCallback113((newConcurrency) => {
    setNumberOfGifLoops(newConcurrency);
  }, [setNumberOfGifLoops]);
  const onNumberOfGifLoopsChanged = useCallback113((e) => {
...
var RenderModalGif = ({
  ...
  const onShouldLimitNumberOfGifLoops = useCallback114((e) => {
    setLimitNumberOfGifLoops(e.target.checked);
  }, [setLimitNumberOfGifLoops]);
  return /* @__PURE__ */ jsxs122("div", {
    style: container53,
    children: [
      /* @__PURE__ */ jsx234(NumberSetting, {
        ...
        children: [
          /* @__PURE__ */ jsxs122("div", {
            ...
            children: [
              ...
              /* @__PURE__ */ jsx234(OptionExplainerBubble, {
          ...
          /* @__PURE__ */ jsx234("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx234(Checkbox, {
      ...
      limitNumberOfGifLoops ? /* @__PURE__ */ jsx234(NumberOfLoopsSetting, {
...
import { useCallback as useCallback115, useMemo as useMemo115 } from "react";
...
var JpegQualitySetting = ({ jpegQuality, setJpegQuality }) => {
  return /* @__PURE__ */ jsx235(NumberSetting, {
...
// src/components/RenderModal/RenderModalPicture.tsx
import { jsx as jsx237, jsxs as jsxs123, Fragment as Fragment39 } from "react/jsx-runtime";
...
var RenderModalPicture = ({
  ...
  const colorSpaceOptions = useMemo115(() => {
    return BrowserSafeApis7.validColorSpaces.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: colorSpace === option ? /* @__PURE__ */ jsx237(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  const qualityControlOptions = useMemo115(() => {
  ...
  const onTargetVideoBitrateChanged = useCallback115((e) => {
    setCustomTargetVideoBitrateValue(e.target.value);
  }, [setCustomTargetVideoBitrateValue]);
  const onEncodingBufferSizeToggled = useCallback115((e) => {
    setEncodingBufferSize(e.target.checked ? "10000k" : null);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateToggled = useCallback115((e) => {
    setEncodingMaxRate(e.target.checked ? "5000k" : null);
  }, [setEncodingMaxRate]);
  const onEncodingBufferSizeChanged = useCallback115((e) => {
    setEncodingBufferSize(e.target.value);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateChanged = useCallback115((e) => {
    ...
    children: [
      renderMode === "video" ? /* @__PURE__ */ jsxs123("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx237("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx237(SegmentedControl, {
              items: imageFormatOptions,
              needsWrapping: false
            })
          })
      ...
      renderMode === "video" && videoImageFormat === "jpeg" && /* @__PURE__ */ jsx237(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "still" && stillImageFormat === "jpeg" && /* @__PURE__ */ jsx237(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "video" && qualityControlType !== null ? /* @__PURE__ */ jsx237(RenderModalHr, {}) : null,
      ...
      qualityControlType === "crf" && renderMode !== "still" && renderMode !== "sequence" && crf !== null ? /* @__PURE__ */ jsx237(CrfSetting, {
        crf,
        min: minCrf,
        max: maxCrf,
        setCrf,
      ...
      qualityControlType === "bitrate" && renderMode === "video" ? /* @__PURE__ */ jsxs123("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx237("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx237("div", {
              children: /* @__PURE__ */ jsx237(RemotionInput, {
                style: input,
      ...
      renderMode === "video" ? /* @__PURE__ */ jsx237(RenderModalHr, {}) : null,
      /* @__PURE__ */ jsx237(ScaleSetting, {
        scale,
        setScale
      }),
      renderMode === "video" ? /* @__PURE__ */ jsx237(RenderModalHr, {}) : null,
      renderMode === "video" ? /* @__PURE__ */ jsxs123("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsx237("div", {
            style: rightRow,
            children: /* @__PURE__ */ jsx237(Combobox, {
...
var RenderModal = ({
  ...
  const chromiumOptions = useMemo116(() => {
    return {
      headless,
      disableWebSecurity,
      ignoreCertificateErrors,
  ...
  const supportsBothQualityControls = useMemo116(() => {
    return supportsCrf && supportsVideoBitrate;
  }, [supportsCrf, supportsVideoBitrate]);
  const qualityControlType = useMemo116(() => {
  ...
  const dispatchIfMounted = useCallback116((payload) => {
    if (isMounted.current === false)
      return;
    dispatch(payload);
  }, []);
  const muted = useMemo116(() => {
    if (renderMode === "video") {
      return mutedState;
    }
    return false;
  }, [mutedState, renderMode]);
  const enforceAudioTrack = useMemo116(() => {
    if (renderMode === "video") {
  ...
  const deriveFinalAudioCodec = useCallback116((passedVideoCodec, passedAudioCodec) => {
  ...
  const setDefaultOutName = useCallback116((options) => {
  ...
  const setAudioCodec = useCallback116((newAudioCodec) => {
  ...
  const setCodec = useCallback116((newCodec) => {
    if (renderMode === "audio") {
  ...
  const setStillFormat = useCallback116((format) => {
    setStillImageFormat(format);
    setDefaultOutName({ type: "still", imageFormat: format });
  }, [setDefaultOutName]);
  const { setSidebarCollapsedState } = useContext75(SidebarContext);
  const onClickStill = useCallback116(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
  ...
  const availablePixelFormats = useMemo116(() => {
    return BrowserSafeApis10.validPixelFormatsForCodec(codec);
  }, [codec]);
  const pixelFormat = useMemo116(() => {
  ...
  const onClickVideo = useCallback116(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const imageFormatOptions = useMemo116(() => {
    if (renderMode === "still") {
      return [
        {
          label: "PNG",
  ...
  const setRenderMode = useCallback116((newRenderMode) => {
  ...
  const renderTabOptions = useMemo116(() => {
  ...
  const pixelFormatOptions = useMemo116(() => {
    return availablePixelFormats.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: pixelFormat === option ? /* @__PURE__ */ jsx238(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  return /* @__PURE__ */ jsxs124("div", {
    style: outer4,
    children: [
      /* @__PURE__ */ jsx238(ModalHeader, {
        title: `Render ${resolvedComposition.id}`
      }),
      /* @__PURE__ */ jsxs124("div", {
        style: container55,
        children: [
          /* @__PURE__ */ jsx238(SegmentedControl, {
      ...
      /* @__PURE__ */ jsxs124("div", {
        ...
        children: [
            ...
            children: [
              shownTabs.includes("general") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx238("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx238(FileIcon, {
                      style: icon6
                    })
                  }),
                  "General"
              ...
              shownTabs.includes("data") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx238("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx238(DataIcon, {
                      style: icon6
                    })
                  }),
                  "Input Props"
              ...
              shownTabs.includes("picture") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx238("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx238(PicIcon, {
                      style: icon6
                    })
                  }),
                  "Picture"
              ...
              shownTabs.includes("audio") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx238("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx238(AudioIcon, {
                      style: icon6
                    })
                  }),
                  "Audio"
              ...
              shownTabs.includes("gif") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx238("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx238(GifIcon, {
                      style: icon6
                    })
                  }),
                  "GIF"
              ...
              shownTabs.includes("advanced") ? /* @__PURE__ */ jsxs124(VerticalTab, {
                ...
                children: [
                  /* @__PURE__ */ jsx238("div", {
                    style: iconContainer,
                    children: /* @__PURE__ */ jsx238(GearIcon, {
                      style: icon6
                    })
                  }),
                  "Other"
          ...
          /* @__PURE__ */ jsx238("div", {
            style: optionsPanel,
            className: VERTICAL_SCROLLBAR_CLASSNAME,
            children: tab === "general" ? /* @__PURE__ */ jsx238(RenderModalBasic, {
              codec,
              resolvedComposition,
              frame: frame2,
              imageFormatOptions,
            ...
            }) : tab === "picture" ? /* @__PURE__ */ jsx238(RenderModalPicture, {
              renderMode,
              scale,
              setScale,
              pixelFormat,
              ...
              encodingMaxRate,
              setEncodingMaxRate
            }) : tab === "audio" ? /* @__PURE__ */ jsx238(RenderModalAudio, {
              muted,
              renderMode,
              setMuted,
              codec,
              ...
              setSeparateAudioTo,
              outName
            }) : tab === "gif" ? /* @__PURE__ */ jsx238(RenderModalGif, {
              everyNthFrame,
              limitNumberOfGifLoops,
              numberOfGifLoopsSetting,
              setEveryNthFrameSetting,
              setLimitNumberOfGifLoops,
              setNumberOfGifLoopsSetting
            }) : tab === "data" ? /* @__PURE__ */ jsx238(DataEditor, {
            ...
            }) : /* @__PURE__ */ jsx238(RenderModalAdvanced, {
              x264Preset,
              setx264Preset,
              concurrency,
              maxConcurrency,
...
var RenderModalWithLoader = (props) => {
  return /* @__PURE__ */ jsx238(DismissableModal, {
    children: /* @__PURE__ */ jsx238(ResolveCompositionBeforeModal, {
      compositionId: props.compositionId,
      children: /* @__PURE__ */ jsx238(RenderModal, {
        ...props
      })
    })
  });
...
import { useCallback as useCallback118, useContext as useContext76 } from "react";
...
// src/components/RenderModal/GuiRenderStatus.tsx
import { jsx as jsx240, jsxs as jsxs125 } from "react/jsx-runtime";
var progressItem = {
  padding: 10,
  display: "flex",
  flexDirection: "row",
...
var BundlingProgress = ({ progress, doneIn }) => {
  return /* @__PURE__ */ jsxs125("div", {
    style: progressItem,
    children: [
      progress === 1 ? /* @__PURE__ */ jsx240(SuccessIcon, {}) : /* @__PURE__ */ jsx240(CircularProgress, {
        progress
      }),
...
var RenderingProgress = ({ progress }) => {
  return /* @__PURE__ */ jsxs125("div", {
    style: progressItem,
    children: [
      progress.frames === progress.totalFrames ? /* @__PURE__ */ jsx240(SuccessIcon, {}) : /* @__PURE__ */ jsx240(CircularProgress, {
...
var OpenFile = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs125("div", {
    style: progressItem,
    children: [
      /* @__PURE__ */ jsx240(SuccessIcon, {}),
      /* @__PURE__ */ jsx240(Spacing, {
        x: 1
      }),
      /* @__PURE__ */ jsx240("button", {
        style: labelStyle5,
        type: "button",
        onClick,
        children: job.outName
      ...
      /* @__PURE__ */ jsx240("div", {
        style: right3,
        children: /* @__PURE__ */ jsx240(RenderQueueOpenInFinderItem, {
          job
        })
      })
    ]
...
var GuiRenderStatus = ({ job }) => {
  ...
  return /* @__PURE__ */ jsxs125("div", {
    children: [
      ...
      /* @__PURE__ */ jsx240(BundlingProgress, {
        progress: job.progress.bundling.progress,
        doneIn: job.progress.bundling.doneIn
      }),
      job.progress.rendering ? /* @__PURE__ */ jsx240(RenderingProgress, {
        progress: job.progress.rendering
      }) : null,
      job.progress.stitching ? /* @__PURE__ */ jsx240(StitchingProgress, {
        progress: job.progress.stitching
      }) : null,
      job.progress.downloads.length > 0 ? /* @__PURE__ */ jsx240(DownloadsProgress, {
        downloads: job.progress.downloads
      }) : null,
      job.status === "done" ? /* @__PURE__ */ jsx240(OpenFile, {
        job
      }) : null,
      /* @__PURE__ */ jsx240(Spacing, {
        y: 1
...
// src/components/RenderModal/RenderStatusModal.tsx
import { jsx as jsx241, jsxs as jsxs126, Fragment as Fragment40 } from "react/jsx-runtime";
var container56 = {
  padding: 20,
  maxWidth: 900,
  paddingTop: 0
...
var RenderStatusModal = ({
  ...
  const onQuit = useCallback118(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  const onRetry = useCallback118(() => {
    const retryPayload = makeRetryPayload(job);
    setSelectedModal(retryPayload);
  }, [job, setSelectedModal]);
  const onClickOnRemove = useCallback118(() => {
    setSelectedModal(null);
    removeRenderJob(job).catch((err) => {
      showNotification(`Could not remove job: ${err.message}`, 2000);
    });
  }, [job, setSelectedModal]);
  const onClickOnCancel = useCallback118(() => {
    cancelRenderJob(job).catch((err) => {
      showNotification(`Could not cancel job: ${err.message}`, 2000);
    });
  }, [job]);
    ...
    children: [
      ...
      /* @__PURE__ */ jsxs126("div", {
        ...
        children: [
          ...
          job.status === "done" || job.status === "running" ? /* @__PURE__ */ jsx241(GuiRenderStatus, {
            job
          }) : null,
          /* @__PURE__ */ jsx241("div", {
            style: spacer3
          ...
          /* @__PURE__ */ jsxs126("div", {
            style: buttonRow,
            children: [
              job.status === "running" ? /* @__PURE__ */ jsx241(Button, {
              ...
              /* @__PURE__ */ jsx241(Flex, {}),
              job.status === "failed" ? /* @__PURE__ */ jsx241(Button, {
                onClick: onRetry,
                children: "Retry"
              }) : null,
              /* @__PURE__ */ jsx241("div", {
...
import { useCallback as useCallback121, useMemo as useMemo119 } from "react";

// src/components/CopyButton.tsx
import { useCallback as useCallback119, useEffect as useEffect71, useState as useState71 } from "react";
import { jsx as jsx242, jsxs as jsxs127 } from "react/jsx-runtime";
var iconStyle8 = {
  width: 16,
  height: 16,
  color: "white"
...
var copyIcon = /* @__PURE__ */ jsx242("svg", {
  "aria-hidden": "true",
  focusable: "false",
  "data-prefix": "far",
  "data-icon": "clipboard",
...
import { useCallback as useCallback120, useMemo as useMemo118, useState as useState72 } from "react";
...
var OpenIssueButton = ({ link: link3 }) => {
  ...
  const handleClick = useCallback120(() => {
    window.open(link3, "_blank");
  }, [link3]);
  const svgFillColor = useMemo118(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const openInEditorSvg = /* @__PURE__ */ jsx243("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle4,
  ...
  const onPointerEnter = useCallback120(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback120(() => {
    setHovered(false);
  }, []);
  return /* @__PURE__ */ jsx243("button", {
    title: buttonTooltip,
    type: "button",
    onPointerEnter,
    onPointerLeave,
...
import { jsx as jsx244, jsxs as jsxs128 } from "react/jsx-runtime";
var container57 = {
  display: "flex",
  flexDirection: "row",
  alignItems: "center"
  ...
  const bugElements = bugs.map((bug) => {
    return /* @__PURE__ */ jsxs128("div", {
      ...
      children: [
        ...
        /* @__PURE__ */ jsx244(OpenIssueButton, {
          link: bug.link
        })
      ]
    }, bug.description + bug.link);
  });
  return /* @__PURE__ */ jsx244("div", {
    children: bugElements
  });
};

// src/components/UpdateModal/UpdateModal.tsx
import { jsx as jsx245, jsxs as jsxs129, Fragment as Fragment41 } from "react/jsx-runtime";
var container58 = {
  padding: 20,
  paddingTop: 0
};
      ...
      /* @__PURE__ */ jsxs129("div", {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxs129(Row, {
            align: "center",
            children: [
              /* @__PURE__ */ jsx245(Flex, {
                children: /* @__PURE__ */ jsx245("pre", {
                  onClick,
                  style: code,
                  children: command
                })
...
// src/components/Modals.tsx
import { jsx as jsx246, jsxs as jsxs130, Fragment as Fragment42 } from "react/jsx-runtime";
var Modals = ({ readOnlyStudio }) => {
  const { selectedModal: modalContextType } = useContext77(ModalsContext);
  const canRender = useContext77(StudioServerConnectionCtx).previewServerState.type === "connected";
  return /* @__PURE__ */ jsxs130(Fragment42, {
    children: [
      modalContextType && modalContextType.type === "duplicate-comp" && /* @__PURE__ */ jsx246(DuplicateComposition, {
        compositionType: modalContextType.compositionType,
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "delete-comp" && /* @__PURE__ */ jsx246(DeleteComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "rename-comp" && /* @__PURE__ */ jsx246(RenameComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && canRender && modalContextType.type === "render" && /* @__PURE__ */ jsx246(RenderModalWithLoader, {
      ...
      modalContextType && modalContextType.type === "update" && /* @__PURE__ */ jsx246(UpdateModal, {
        info: modalContextType.info,
        knownBugs: modalContextType.knownBugs
      }),
      modalContextType && modalContextType.type === "install-packages" && /* @__PURE__ */ jsx246(InstallPackageModal, {
        packageManager: modalContextType.packageManager
      }),
      modalContextType && modalContextType.type === "quick-switcher" && /* @__PURE__ */ jsx246(QuickSwitcher_default, {
        readOnlyStudio,
...
// src/components/Editor.tsx
import { jsx as jsx247, jsxs as jsxs131 } from "react/jsx-runtime";
var background2 = {
  backgroundColor: BACKGROUND,
  display: "flex",
  width: "100%",
...
var Editor = ({ Root, readOnlyStudio }) => {
  const size4 = PlayerInternals17.useElementSize(drawRef, {
    triggerOnWindowResize: false,
    shouldApplyCssTransforms: true
  });
  useEffect72(() => {
  ...
  const onMounted = useCallback122(() => {
    setCanvasMounted(true);
  }, []);
  const value = useMemo120(() => {
    if (!size4) {
      return null;
    }
    return {
  ...
  const MemoRoot = useMemo120(() => {
    return React166.memo(Root);
  }, [Root]);
  return /* @__PURE__ */ jsx247(HigherZIndex, {
    onEscape: noop,
    onOutsideClick: noop,
    children: /* @__PURE__ */ jsxs131(TimelineZoomContext, {
      children: [
        /* @__PURE__ */ jsx247(Internals57.CurrentScaleContext.Provider, {
          value,
          children: /* @__PURE__ */ jsxs131("div", {
            style: background2,
            children: [
              canvasMounted ? /* @__PURE__ */ jsx247(MemoRoot, {}) : null,
              /* @__PURE__ */ jsxs131(Internals57.CanUseRemotionHooksProvider, {
                children: [
                  /* @__PURE__ */ jsx247(EditorContent, {
                    readOnlyStudio,
                    children: /* @__PURE__ */ jsx247(TopPanel, {
                      size: size4,
                      drawRef,
                  ...
                  /* @__PURE__ */ jsx247(GlobalKeybindings, {})
                ]
              })
            ]
          })
        }),
        /* @__PURE__ */ jsx247(Modals, {
          readOnlyStudio
        }),
        /* @__PURE__ */ jsx247(NotificationCenter, {})
      ]
    })
  });
};
...
import { useCallback as useCallback123, useContext as useContext78, useMemo as useMemo121, useState as useState73 } from "react";
...
var PreviewSizeProvider = ({ children }) => {
  ...
  const { editorZoomGestures } = useContext78(EditorZoomGesturesContext);
  const setSize = useCallback123((newValue) => {
  ...
  const previewSizeCtx = useMemo121(() => {
    return {
  ...
  return /* @__PURE__ */ jsx248(Internals58.PreviewSizeContext.Provider, {
...
import { useCallback as useCallback124, useMemo as useMemo122, useState as useState74 } from "react";
...
var CheckerboardProvider = ({ children }) => {
  ...
  const setCheckerboard = useCallback124((newValue) => {
  ...
  const checkerboardCtx = useMemo122(() => {
    return {
      checkerboard,
      setCheckerboard
    };
  }, [checkerboard, setCheckerboard]);
  return /* @__PURE__ */ jsx249(CheckerboardContext.Provider, {
...
import { useMemo as useMemo123, useState as useState75 } from "react";
...
var MediaVolumeProvider = ({ children }) => {
  ...
  const mediaVolumeContextValue = useMemo123(() => {
    return {
      mediaMuted,
      mediaVolume
    };
  }, [mediaMuted, mediaVolume]);
  const setMediaVolumeContextValue = useMemo123(() => {
    return {
      setMediaMuted,
      setMediaVolume
    };
  }, []);
  return /* @__PURE__ */ jsx250(Internals59.MediaVolumeContext.Provider, {
    value: mediaVolumeContextValue,
    children: /* @__PURE__ */ jsx250(Internals59.SetMediaVolumeContext.Provider, {
...
import { useMemo as useMemo124, useState as useState76 } from "react";
...
var ModalsProvider = ({ children }) => {
  ...
  const modalsContext = useMemo124(() => {
    return {
      selectedModal: modalContextType,
      setSelectedModal: setModalContextType
    };
  }, [modalContextType]);
  return /* @__PURE__ */ jsx251(ModalsContext.Provider, {
    value: modalsContext,
    children
  });
};
...
import { useEffect as useEffect73, useMemo as useMemo125, useState as useState77 } from "react";
...
var SetTimelineInOutProvider = ({ children }) => {
  ...
  const setTimelineInOutContextValue = useMemo125(() => {
    return {
      setInAndOutFrames
    };
  }, []);
  ...
  return /* @__PURE__ */ jsx252(TimelineInOutContext.Provider, {
    value: inAndOutFrames,
    children: /* @__PURE__ */ jsx252(SetTimelineInOutContext.Provider, {
...
import { useCallback as useCallback125, useMemo as useMemo126, useRef as useRef38, useState as useState78 } from "react";
...
var ShowGuidesProvider = ({ children }) => {
  ...
  const setEditorShowGuides = useCallback125((newValue) => {
  ...
  const editorShowGuidesCtx = useMemo126(() => {
    return {
      editorShowGuides,
      setEditorShowGuides,
      guidesList,
  ...
  return /* @__PURE__ */ jsx253(EditorShowGuidesContext.Provider, {
...
import { useCallback as useCallback126, useMemo as useMemo127, useState as useState79 } from "react";
...
var ShowRulersProvider = ({ children }) => {
  ...
  const setEditorShowRulers = useCallback126((newValue) => {
  ...
  const editorShowRulersCtx = useMemo127(() => {
    return {
      editorShowRulers,
      setEditorShowRulers
    };
  }, [editorShowRulers, setEditorShowRulers]);
  return /* @__PURE__ */ jsx254(EditorShowRulersContext.Provider, {
...
import { useCallback as useCallback127, useMemo as useMemo128, useState as useState80 } from "react";
...
var ZoomGesturesProvider = ({ children }) => {
  ...
  const setEditorZoomGestures = useCallback127((newValue) => {
  ...
  const editorZoomGesturesCtx = useMemo128(() => {
    return {
      editorZoomGestures,
      setEditorZoomGestures
    };
  }, [editorZoomGestures, setEditorZoomGestures]);
  return /* @__PURE__ */ jsx255(EditorZoomGesturesContext.Provider, {
...
var EditorContexts = ({ children, readOnlyStudio }) => {
  return /* @__PURE__ */ jsx256(ZodProvider, {
    children: /* @__PURE__ */ jsx256(PreviewServerConnection, {
      readOnlyStudio,
      children: /* @__PURE__ */ jsx256(RenderQueueContextProvider, {
        children: /* @__PURE__ */ jsx256(KeybindingContextProvider, {
          children: /* @__PURE__ */ jsx256(CheckerboardProvider, {
            children: /* @__PURE__ */ jsx256(ZoomGesturesProvider, {
              children: /* @__PURE__ */ jsx256(ShowRulersProvider, {
                children: /* @__PURE__ */ jsx256(ShowGuidesProvider, {
                  children: /* @__PURE__ */ jsx256(PreviewSizeProvider, {
                    children: /* @__PURE__ */ jsx256(ModalsProvider, {
                      children: /* @__PURE__ */ jsx256(MediaVolumeProvider, {
                        children: /* @__PURE__ */ jsx256(PlayerInternals18.PlayerEmitterProvider, {
                          currentPlaybackRate: null,
                          children: /* @__PURE__ */ jsx256(SidebarContextProvider, {
                            children: /* @__PURE__ */ jsx256(FolderContextProvider, {
                              children: /* @__PURE__ */ jsx256(HighestZIndexProvider, {
                                children: /* @__PURE__ */ jsx256(SetTimelineInOutProvider, {
                                  children
                                })
                              })
                            })
...
import { jsx as jsx257, jsxs as jsxs132 } from "react/jsx-runtime";
var container59 = {
  position: "fixed",
  justifyContent: "flex-end",
  alignItems: "flex-start",
...
var ServerDisconnected = () => {
  const { previewServerState: ctx } = useContext79(StudioServerConnectionCtx);
...
var injectCSS = () => {
  ...
  Internals60.CSSUtils.injectCSS(makeDefaultGlobalCSS());
  injected = true;
};

// src/Studio.tsx
import { jsx as jsx258, jsxs as jsxs133 } from "react/jsx-runtime";
...
var Studio = ({ rootComponent, readOnly }) => {
  ...
  return /* @__PURE__ */ jsx258(Internals61.RemotionRoot, {
    numberOfAudioTags: window.remotion_numberOfAudioTags,
    children: /* @__PURE__ */ jsxs133(EditorContexts, {
      readOnlyStudio: readOnly,
      children: [
        /* @__PURE__ */ jsx258(Editor, {
          readOnlyStudio: readOnly,
          Root: rootComponent
        }),
        readOnly ? null : createPortal(/* @__PURE__ */ jsx258(ServerDisconnected, {}), getServerDisconnectedDomElement())
      ]
    })
  });
};
